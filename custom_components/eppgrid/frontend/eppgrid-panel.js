      ...
      <div class="settings-section">
        ...
        <div class="setting-group">
          ...
          <div class="setting-row">
            ...
            <label class="toggle-switch"><input type="checkbox" @change=${t=>{const e=t.target,i=e.dataset.entityKey;this._overrides.entities||(this._overrides.entities={}),this._overrides.entities[i]=e.checked,this._fireDirty()}} data-entity-key="zone_presence" .checked=${i("zone_presence",!0)} /><span class="toggle-slider"></span></label>
