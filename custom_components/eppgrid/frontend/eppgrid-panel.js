...
`;class oe extends ct{constructor(){super(...arguments),this.furniture=[],this.selectedFurnitureId=null,this.hass=void 0,this.localize=t=>t,this.showCustomIconPicker=!1,this.customIconValue=""}render(){return this._renderFurnitureSidebar()}_renderFurnitureSidebar(){const t=this.furniture.find(t=>t.id===this.selectedFurnitureId);return W`
		...
		`}_renderVisibleCells(t,e,i,o,s){const n=this.heatmapColors,r=this.occupancy,a=[];for(let l=i;l<=o;l++)for(let i=t;i<=e;i++){const t=l*xt+i,e=this.grid[t];let o=re(e,this.zoneConfigs),c="";if(Ct(e)){const t=Tt(e);if(n){const e=n.get(t);e&&(o=`linear-gradient(${e}, ${e}), linear-gradient(${o}, ${o})`)}r[t]&&(c="box-shadow: inset 0 0 0 1px rgba(0,0,0,0.4);")}a.push(W`
					<div
						class="cell"
