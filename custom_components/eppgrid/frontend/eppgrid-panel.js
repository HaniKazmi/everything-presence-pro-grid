				...
				${this.furniture.map(t=>{const o=(e-this.minCol)*i+this._mmToPx(t.x),s=(0-this.minRow)*i+this._mmToPx(t.y),n=this._mmToPx(t.width),r=this._mmToPx(t.height),a=this.selectedFurnitureId===t.id;return W`
						...
						>
							${"svg"===t.type&&Pt[t.icon]?Z`<svg viewBox="${Pt[t.icon].viewBox}" preserveAspectRatio="none" class="furn-svg">
										${xt(Pt[t.icon].content)}
									</svg>`:W`<ha-icon icon="${t.icon}" style="--mdc-icon-size: ${.6*Math.min(n,r)}px;"></ha-icon>`}
							${a?W`
										<!-- Resize handles -->
...
`;class oe extends ct{constructor(){super(...arguments),this.furniture=[],this.selectedFurnitureId=null,this.hass=void 0,this.localize=t=>t,this.showCustomIconPicker=!1,this.customIconValue=""}render(){return this._renderFurnitureSidebar()}_renderFurnitureSidebar(){const t=this.furniture.find(t=>t.id===this.selectedFurnitureId);return W`
		...
		`],t([pt({attribute:!1})],oe.prototype,"furniture",void 0),t([pt({attribute:!1})],oe.prototype,"selectedFurnitureId",void 0),t([pt({attribute:!1})],oe.prototype,"hass",void 0),t([pt({attribute:!1})],oe.prototype,"localize",void 0),t([pt({attribute:!1})],oe.prototype,"showCustomIconPicker",void 0),t([pt({attribute:!1})],oe.prototype,"customIconValue",void 0),customElements.get("epp-furniture-sidebar")||customElements.define("epp-furniture-sidebar",oe);const ne=Et*Math.sin(Math.PI/3);function re(t,e){if(!Ct(t))return"var(--secondary-background-color, #e0e0e0)";const i=Tt(t);if(i>0&&i<=7){const t=e[i-1];if(t)return t.color}return"var(--card-background-color, #fff)"}function ae(t){return{r:parseInt(t.slice(1,3),16),g:parseInt(t.slice(3,5),16),b:parseInt(t.slice(5,7),16)}}function le(t,e,i){const o=t[6]*e+t[7]*i+1;return{x:(t[0]*e+t[1]*i+t[2])/o,y:(t[3]*e+t[4]*i+t[5])/o}}function ce(t){return t?le(t,0,0):null}function he(t,e,i,o){if(t<=0||e<=0)return 0;const s=ce(i);if(s){const e=Math.ceil(t/kt),i=Math.floor((wt-e)/2);let n=0;const r=At(o);for(let t=r.minRow;t<=r.maxRow;t++)for(let e=r.minCol;e<=r.maxCol;e++){if(!Ct(o[t*wt+e]))continue;const r=(t+.5)*kt,a=(e-i+.5)*kt-s.x,l=r-s.y,c=Math.sqrt(a*a+l*l);c>n&&(n=c)}if(n>0){const t=n/1e3;return Math.ceil(2*t)/2}}const n=Math.max(t,e)/1e3;return Math.ceil(2*n)/2}function de(t){if(0===t.length)return 0;const e=[...t].sort((t,e)=>t-e),i=Math.floor(e.length/2);return e.length%2?e[i]:(e[i-1]+e[i])/2}function ue(t,e,i){const o=At(t);if(o.minCol>o.maxCol)return null;const s=o.maxCol-o.minCol+1,n=o.maxRow-o.minRow+1,r=s*kt,a=n*kt,l=ce(i),c=Math.ceil(e/kt),h=Math.floor((wt-c)/2),d=l?l.x:r/2,u=l?l.y:0;let p=0;for(let e=0;e<zt;e++){if(!Ct(t[e]))continue;const i=e%wt,o=Math.floor(e/wt),s=(i-h+.5)*kt-d,n=(o+.5)*kt-u,r=s*s+n*n;r>p&&(p=r)}return{widthM:(r/1e3).toFixed(1),depthM:(a/1e3).toFixed(1),furthestM:(Math.sqrt(p)/1e3).toFixed(1)}}class pe extends ct{constructor(){super(...arguments),this.grid=new Uint8Array(0),this.zoneConfigs=[],this.targets=[],this.roomWidth=0,this.roomDepth=0,this.perspective=null,this.furniture=[],this.selectedFurnitureId=null,this.sidebarTab="zones",this.editable=!1,this.activeZone=null,this.showHitCounts=!1,this.occupancy={},this.targetPrevXY=[],this.heatmapColors=null,this.localize=t=>t,this.maxGridPx=480,this.frozenBounds=null}render(){const t=this.frozenBounds??Dt(this.grid),e=t.minCol>t.maxCol,i=e?0:t.minCol,o=e?19:t.maxCol,s=e?0:t.minRow,n=t.maxRow,r=o-i+1,a=n-s+1,l=Math.min(Math.floor(this.maxGridPx/r),Math.floor(this.maxGridPx/a),32);return W`
			<div class="grid-targets-wrapper">
				<div
					class="grid"
					style="grid-template-columns: repeat(${r}, ${l}px); grid-template-rows: repeat(${a}, ${l}px);"
					@mouseup=${this._onCellMouseUp}
				>
					${this._renderVisibleCells(i,o,s,n,l)}
				</div>
				${this._renderFurnitureOverlay(l,i,s,r,a)}
				${this._renderTargetDots(i,s,r,a)}
			</div>
			${this._renderGridDimensions()}
		`}_renderVisibleCells(t,e,i,o,s){const n=this.heatmapColors,r=this.occupancy,a=[];for(let l=i;l<=o;l++)for(let i=t;i<=e;i++){const t=l*wt+i,e=this.grid[t];let o=re(e,this.zoneConfigs),c="";if(Ct(e)){const t=Tt(e);if(n){const e=n.get(t);e&&(o=`linear-gradient(${e}, ${e}), linear-gradient(${o}, ${o})`)}r[t]&&(c="box-shadow: inset 0 0 0 1px rgba(0,0,0,0.4);")}a.push(W`
					<div
						class="cell"
			...
			<div class="targets-overlay" style="pointer-events: none;">
				${this.targets.map((s,n)=>{if("inactive"===s.status)return V;let r=null!=s.x?se(s.x,s.y,this.roomWidth,this.roomDepth):null;const a=r&&r.col>=t&&r.col<=t+i&&r.row>=e&&r.row<=e+o;if("pending"===s.status&&!a&&this.targetPrevXY[n]&&(r=se(this.targetPrevXY[n].x,this.targetPrevXY[n].y,this.roomWidth,this.roomDepth)),!r)return V;const l=Math.max(0,Math.min(100,(r.col-t)/i*100)),c=Math.max(0,Math.min(100,(r.row-e)/o*100));return W`
						<div
							class="target-dot"
							style="left: ${l}%; top: ${c}%; background: ${Rt[n]||Rt[0]}; opacity: ${"pending"===s.status?.3:1}; transition: opacity 0.5s ease;"
						></div>
  ...
  `,t([pt({attribute:!1})],ge.prototype,"sensorState",void 0),t([pt({attribute:!1})],ge.prototype,"zoneState",void 0),t([pt({attribute:!1})],ge.prototype,"zoneConfigs",void 0),t([pt({attribute:!1})],ge.prototype,"perspective",void 0),t([pt({attribute:!1})],ge.prototype,"localize",void 0),t([gt()],ge.prototype,"_expandedSensorInfo",void 0),customElements.get("epp-live-sidebar")||customElements.define("epp-live-sidebar",ge);class me extends ct{constructor(){super(...arguments),this.sensorState={occupancy:!1,static_presence:!1,motion_presence:!1,target_presence:!1,illuminance:null,temperature:null,humidity:null,co2:null},this.targetAutoDistance=!0,this.targetMaxDistance=6,this.staticAutoDistance=!0,this.staticMinDistance=.3,this.staticMaxDistance=16,this.openAccordions=new Set,this.perspective=null,this.roomWidth=0,this.roomDepth=0,this.grid=new Uint8Array(0),this.saving=!1,this.dirty=!1,this.temperatureOffset=0,this.humidityOffset=0,this.illuminanceOffset=0,this.motionTimeout=5,this.staticTimeout=30,this.staticTriggerThreshold=3,this.staticRenewThreshold=3,this.staticOnDelay=0,this.entitiesConfig={},this.localize=t=>t}render(){return W`
    ...
    `,e=(t,e,i,o)=>{const s=i-t,n=o-e,r=Math.sqrt(s*s+n*n),a=s/r,l=n/r,c=i-40*a,h=o-40*l;return Z`
      ...
      `},i=50,o=55,s=290,n=55,r=290,a=225,l=50,c=235,h=98,d=225,u=Z`
      <svg viewBox="0 0 360 290" width="360" height="290" style="display: block; margin: 0 auto;">
        ...
        <circle cx="${s}" cy="${n}" r="14" fill="#4CAF50" opacity="0.15"/>
        <circle cx="${s}" cy="${n}" r="14" fill="none" stroke="#4CAF50" stroke-width="2.5"/>
        <text x="${s}" y="${n+5}" font-size="14" fill="#4CAF50" font-weight="bold" text-anchor="middle">2</text>

        <!-- Corner 3: back-right -->
        <circle cx="${r}" cy="${a}" r="14" fill="#4CAF50" opacity="0.15"/>
        <circle cx="${r}" cy="${a}" r="14" fill="none" stroke="#4CAF50" stroke-width="2.5"/>
        <text x="${r}" y="${a+5}" font-size="14" fill="#4CAF50" font-weight="bold" text-anchor="middle">3</text>

        <!-- Sensor icon outside the top-right corner -->
        <g transform="translate(${s+18}, ${n-18}) rotate(-45)">
        ...
        <text x="${s+24}" y="${n-24}" font-size="10" fill="var(--primary-color, #03a9f4)" font-weight="500">${this.localize("wizard.sensor")}</text>
      </svg>
    `;return W`
    ...
    `}_renderWizardCorners(){const t=this._wizardCornerIndex,e=this.rawTargets.filter(t=>null!=t.raw_x&&null!=t.raw_y),i=e.length>0,o=e.length>1,s=this._wizardCorners.every(t=>null!==t),n=Bt[t]||"",[r,a]=Lt[t]||["",""];return W`
      <div class="wizard-card">
        ...
        ${s?V:W`
            <p class="corner-instruction">
              ${this.localize("wizard.corner_step",{index:t+1,corner:this.localize(n)})}
            </p>
        `}

        <div class="corner-progress">
          ${Bt.map((e,i)=>{const o=!!this._wizardCorners[i],s=i<3,n=i<t;return W`
                <span
        ...
        <div class="corner-offsets" key="${t}">
          ...
          <input
            ...
            min="0"
            step="1"
            placeholder="${this.localize("wizard.distance_from_side",{wall:this.localize(r)})}"
        ...
        <div class="wizard-actions">
          ...
          `:W`
            ...
            >
              ${this.localize("wizard.mark_corner",{corner:this.localize(n)})}
            </button>
          `}
        </div>
      </div>
    `}_renderMiniSensorView(){const t=Ot,e=Et,i=200,o=-t,s=e*Math.cos(Nt),n=`M 0 0 L ${o} ${s} A 6000 6000 0 0 0 ${t} ${s} Z`,r=[2e3,4e3].map(t=>{const e=t*Math.sin(Nt),i=t*Math.cos(Nt);return`M ${-e} ${i} A ${t} ${t} 0 0 0 ${e} ${i}`});return W`
    ...
    `}_renderUncalibratedFov(){const t=this.sensorState.occupancy,e=t?"#4CAF50":"var(--primary-color, #03a9f4)",i=160,o=14,s=180,n=30*Math.PI/180,r=150*Math.PI/180,a=i+s*Math.cos(n),l=o+s*Math.sin(n),c=i+s*Math.cos(r),h=o+s*Math.sin(r);return W`
      <div style="display: flex; flex-direction: column; align-items: center; padding: 24px;">
        <svg viewBox="0 0 320 210" width="320" height="210" style="display: block;">
          ...
          <!-- Range arcs -->
          ${[60,120,180].map(t=>{const s=i+t*Math.cos(n),a=o+t*Math.sin(n),l=i+t*Math.cos(r),c=o+t*Math.sin(r);return Z`
          ...
          <!-- Target dots -->
          ${this.rawTargets.map((t,e)=>{if(null==t.raw_x||null==t.raw_y)return V;const n=Math.sqrt(t.raw_x*t.raw_x+t.raw_y*t.raw_y),r=Math.atan2(t.raw_x,t.raw_y),a=Math.min(n/6e3,1)*s,l=Math.PI/2-r,c=i+a*Math.cos(l),h=o+a*Math.sin(l);return Z`<circle cx="${c}" cy="${h}" r="5" fill="${Rt[e]||Rt[0]}"/>`})}
    ...
    `,e=(()=>{const t=28,e=28,i=180,o=-15*Math.PI/180,s=105*Math.PI/180,n=t+i*Math.cos(o),r=e+i*Math.sin(o),a=t+i*Math.cos(s),l=e+i*Math.sin(s),c=(i,n)=>{const r=t+i*Math.cos(o),a=e+i*Math.sin(o),l=t+i*Math.cos(s),c=e+i*Math.sin(s),h=45*Math.PI/180,d=t+(i-10)*Math.cos(h),u=e+(i-10)*Math.sin(h);return Z`
          <path d="M ${r} ${a} A ${i} ${i} 0 0 1 ${l} ${c}"
        ...
        <svg viewBox="0 0 200 160" width="200" height="160" style="display: block;">
          ...
          <path d="M ${t} ${e} L ${a} ${l} A ${i} ${i} 0 0 0 ${n} ${r} Z"
                fill="var(--primary-color, #03a9f4)" opacity="0.08"
                clip-path="url(#room-clip)"/>
          <!-- Cone edge lines -->
          <line x1="${t}" y1="${e}" x2="${n}" y2="${r}" stroke="var(--primary-color, #03a9f4)" stroke-width="0.5" opacity="0.3" clip-path="url(#room-clip)"/>
    ...
    `}_fireStartCalibration(){this.dispatchEvent(new CustomEvent("start-calibration",{bubbles:!0,composed:!0}))}_fireCancel(){this._setupStep=null,this._wizardCorners=[null,null,null,null],this._wizardCornerIndex=0,this._wizardOffsetSide="",this._wizardOffsetFb="",this.dispatchEvent(new CustomEvent("wizard-cancel",{bubbles:!0,composed:!0}))}}fe.styles=[Xt,Qt,Kt,r`
      :host {
        display: block;
      }
    ...
    `],t([pt({attribute:!1})],fe.prototype,"hass",void 0),t([pt({type:String})],fe.prototype,"selectedMac",void 0),t([pt({attribute:!1})],fe.prototype,"rawTargets",void 0),t([pt({attribute:!1})],fe.prototype,"sensorState",void 0),t([pt({attribute:!1})],fe.prototype,"devices",void 0),t([pt({attribute:!1})],fe.prototype,"localize",void 0),t([pt({type:Number})],fe.prototype,"initialRoomWidth",void 0),t([pt({type:Number})],fe.prototype,"initialRoomDepth",void 0),t([pt({type:String})],fe.prototype,"mode",void 0),t([gt()],fe.prototype,"_setupStep",void 0),t([gt()],fe.prototype,"_wizardSaving",void 0),t([gt()],fe.prototype,"_wizardCornerIndex",void 0),t([gt()],fe.prototype,"_wizardCorners",void 0),t([gt()],fe.prototype,"_wizardRoomWidth",void 0),t([gt()],fe.prototype,"_wizardRoomDepth",void 0),t([gt()],fe.prototype,"_wizardCapturing",void 0),t([gt()],fe.prototype,"_wizardCaptureProgress",void 0),t([gt()],fe.prototype,"_wizardCapturePaused",void 0),t([gt()],fe.prototype,"_wizardOffsetSide",void 0),t([gt()],fe.prototype,"_wizardOffsetFb",void 0),customElements.get("epp-wizard")||customElements.define("epp-wizard",fe);const _e={normal:{trigger:5,renew:3,timeout:10,handoff_timeout:3},entrance:{trigger:3,renew:2,timeout:5,handoff_timeout:1},thoroughfare:{trigger:3,renew:2,timeout:3,handoff_timeout:1},rest:{trigger:7,renew:1,timeout:30,handoff_timeout:10}},ve=["#E69F00","#56B4E9","#009E73","#F0E442","#0072B2","#D55E00","#CC79A7"];function be(t,e,i,o,s,n,r,a){if(0===t){const t=_e[i]||_e.normal;return"custom"===i?{trigger:o,renew:s,timeout:n,handoffTimeout:r,entryPoint:a}:{trigger:t.trigger,renew:t.renew,timeout:t.timeout,handoffTimeout:t.handoff_timeout,entryPoint:!1}}if(t>0&&t<=e.length){const i=e[t-1];if(i){const t=_e[i.type]||_e.normal;return"custom"===i.type?{trigger:i.trigger??t.trigger,renew:i.renew??t.renew,timeout:i.timeout??t.timeout,handoffTimeout:i.handoff_timeout??t.handoff_timeout,entryPoint:i.entry_point??!1}:{trigger:t.trigger,renew:t.renew,timeout:t.timeout,handoffTimeout:t.handoff_timeout,entryPoint:"entrance"===i.type}}}return{trigger:5,renew:3,timeout:10,handoffTimeout:3,entryPoint:!1}}class ye extends ct{constructor(){super(...arguments),this.zoneConfigs=[],this.activeZone=null,this.roomType="normal",this.roomTrigger=_e.normal.trigger,this.roomRenew=_e.normal.renew,this.roomTimeout=_e.normal.timeout,this.roomHandoffTimeout=_e.normal.handoff_timeout,this.roomEntryPoint=!1,this.localZoneState=new Map,this.localize=t=>t}render(){return this._renderZoneSidebar()}_renderZoneSidebar(){return W`
		...
		`}_renderZoneTypeControls(t,e){const i="custom"===t.type,o=_e[t.type]||_e.normal,s=t.trigger??o.trigger,n=t.renew??o.renew,r=t.timeout??o.timeout,a=t.handoff_timeout??o.handoff_timeout,l=`width: 100%; display: flex; align-items: center; gap: 4px; font-size: 12px; opacity: ${i?1:.5};`;return W`
			<div
				class="zone-item-row zone-settings-row"
				style="flex-wrap: wrap; gap: 3px; padding: 4px 8px;"
			>
    ...
    `}_toggleAccordion(t){this._openAccordions=this._openAccordions.has(t)?new Set:new Set([t])}_getSensorRoomPosition(){return ce(this._perspective)}_autoDetectionRange(){return he(this._roomWidth,this._roomDepth,this._perspective,this._grid)}_renderSettings(){return W`
      <div class="panel">
        ...
        <epp-settings-view
          ...
          @setting-change=${t=>{const{key:e,value:i}=t.detail;this[`_${e}`]=i,(e.includes("Distance")||e.includes("Auto"))&&this._onDetectionDistanceChange()}}
          @dirty=${()=>{this._dirty=!0}}
    ...
    `}_renderFurnitureOverlay(t,e,i,o,s){return this._furniture.length?W`
			<epp-furniture-overlay
				...
				@furniture-delete=${t=>{this._removeFurniture(t.detail)}}
			></epp-furniture-overlay>
		`:V}}Fi.styles=[Zt,jt,Vt,Xt,Qt,Jt,ee,ie,r`
    .cell {
      cursor: pointer;
      transition: opacity 0.1s;
    }
