  ...
  `,t([pt({attribute:!1})],ge.prototype,"sensorState",void 0),t([pt({attribute:!1})],ge.prototype,"zoneState",void 0),t([pt({attribute:!1})],ge.prototype,"zoneConfigs",void 0),t([pt({attribute:!1})],ge.prototype,"perspective",void 0),t([pt({attribute:!1})],ge.prototype,"localize",void 0),t([gt()],ge.prototype,"_expandedSensorInfo",void 0),customElements.get("epp-live-sidebar")||customElements.define("epp-live-sidebar",ge);class me extends ct{constructor(){super(...arguments),this.sensorState={occupancy:!1,static_presence:!1,motion_presence:!1,target_presence:!1,illuminance:null,temperature:null,humidity:null,co2:null},this.targetAutoDistance=!0,this.targetMaxDistance=6,this.staticAutoDistance=!0,this.staticMinDistance=.3,this.staticMaxDistance=16,this.openAccordions=new Set,this.perspective=null,this.roomWidth=0,this.roomDepth=0,this.grid=new Uint8Array(0),this.saving=!1,this.dirty=!1,this.temperatureOffset=0,this.humidityOffset=0,this.illuminanceOffset=0,this.motionTimeout=5,this.staticTimeout=30,this.staticTriggerThreshold=3,this.staticRenewThreshold=3,this.staticOnDelay=0,this.entitiesConfig={},this._overrides={},this.localize=t=>t}render(){return W`
    ...
    `}toggleAccordion(t){const e=this.openAccordions.has(t)?new Set:new Set([t]);this.openAccordions=e,this.dispatchEvent(new CustomEvent("accordion-toggle",{detail:e,bubbles:!0,composed:!0}))}renderSettingsSection(t){switch(t){case"detection":return this.renderDetectionRanges();case"sensitivity":return this.renderSensitivities();case"reporting":return this.renderEntities();default:return V}}renderEnvOffset(t,e,i,o,s,r,n,a,l){const c=this[`${i}Offset`]??0,h=null!=e?e-c:null,d=null!=h?(h+c).toFixed(a):"—";return W`
      <div class="setting-row">
        <label>${t}</label>
        <span class="setting-input-unit"><input type="range" class="setting-range" data-offset-key=${i} .value=${String(c)} min=${o} max=${s} step=${r} @input=${t=>{const e=t.target,o=parseFloat(e.value),s=null!=h?(h+o).toFixed(a):"—";e.nextElementSibling.textContent=s,this._overrides[`${i}Offset`]=o,this._fireDirty()}} /><span class="setting-value">${d}</span> ${n}</span>
        ${this.resetBtn(0)}${this.infoTip(l)}
      </div>
    `}_resetSlider(t,e,i){const o=t.querySelector(".setting-range");if(!o)return;const s=parseFloat(o.value);o.value=String(e);const r=o.nextElementSibling;if(r){const t=parseFloat(r.textContent||"");if(o.dataset.offsetKey&&!Number.isNaN(t)){const i=(parseFloat(o.step)||1)<1?1:0;r.textContent=(t-s+e).toFixed(i),this._overrides[`${o.dataset.offsetKey}Offset`]=e}else r.textContent=String(e)}i&&(this._overrides[i]=e);const n=this.shadowRoot?.querySelector(".save-btn");n&&(n.disabled=!1)}resetBtn(t,e){return W`<span class="setting-info" @click=${i=>{i.stopPropagation();const o=i.currentTarget.closest(".setting-row");o&&this._resetSlider(o,t,e)}}><ha-icon icon="mdi:restart"></ha-icon></span>`}infoTip(t){return W`<span class="setting-info"
        ...
        <div class="setting-group">
          ...
          <div class="setting-row">
            ...
            <label class="toggle-switch">
              <input type="checkbox" ?checked=${this.targetAutoDistance}
                @change=${t=>{const e=t.target.checked;e||(this._overrides.targetMaxDistance=i,this._fireChange("targetMaxDistance",i)),this._overrides.targetAutoDistance=e,this._fireChange("targetAutoDistance",e)}} />
          ...
          <div class="setting-row" style="${this.targetAutoDistance?s:""}">
            ...
            <span class="setting-input-unit"><input type="range" class="setting-range" .value=${String(i)} min="0.5" max="6" step="0.1"
              @input=${t=>{const e=t.target,i=Number(e.value);this._overrides.targetMaxDistance=i,this._fireChange("targetMaxDistance",i),e.nextElementSibling.textContent=e.value}} /><span class="setting-value">${i}</span><span class="setting-unit">m</span></span>
        ...
        <div class="setting-group">
          ...
          <div class="setting-row">
            ...
            <label class="toggle-switch">
              <input type="checkbox" ?checked=${this.staticAutoDistance}
                @change=${t=>{const e=t.target.checked;e||(this._overrides.staticMaxDistance=o,this._fireChange("staticMaxDistance",o)),this._overrides.staticAutoDistance=e,this._fireChange("staticAutoDistance",e)}} />
              <span class="toggle-slider"></span>
            </label>
            ${this.infoTip(this.localize("info.target_auto_range"))}
          </div>
          ...
          <div class="setting-row" style="${this.staticAutoDistance?s:""}">
            ...
            <span class="setting-input-unit"><input type="range" class="setting-range" .value=${String(o)} min="2.4" max="16" step="0.1"
              @input=${t=>{const e=t.target;let i=Number(e.value);const o=this._overrides.staticMinDistance??this.staticMinDistance;i<=o&&(i=o+.1,e.value=String(i)),this._overrides.staticMaxDistance=i,this._fireChange("staticMaxDistance",i),e.nextElementSibling.textContent=String(i)}} /><span class="setting-value">${o}</span><span class="setting-unit">m</span></span>
      ...
      <div class="settings-section">
        <div class="setting-group">
          ...
          <div class="setting-row">
            ...
            <span class="setting-input-unit"><input type="range" class="setting-range" .value=${String(this.motionTimeout)} min="0" max="120" step="1" @input=${t=>{const e=t.target;this._overrides.motionTimeout=Number(e.value),e.nextElementSibling.textContent=e.value,this._fireDirty()}} /><span class="setting-value">${this.motionTimeout}</span><span class="setting-unit">s</span></span>
        ...
        <div class="setting-group">
          ...
          <div class="setting-row">
            <label>${this.localize("settings.presence_timeout")}</label>
            <span class="setting-input-unit"><input type="range" class="setting-range" .value=${String(this.staticTimeout)} min="0" max="120" step="1" @input=${t=>{const e=t.target;this._overrides.staticTimeout=Number(e.value),e.nextElementSibling.textContent=e.value,this._fireDirty()}} /><span class="setting-value">${this.staticTimeout}</span><span class="setting-unit">s</span></span>
          ...
          <div class="setting-row">
            ...
            <span class="setting-input-unit"><input type="range" class="setting-range" min="0" max="9" .value=${String(this.staticTriggerThreshold)} @input=${t=>{const e=t.target;this._overrides.staticTriggerThreshold=Number(e.value),e.nextElementSibling.textContent=e.value,this._fireDirty()}} /><span class="setting-value">${this.staticTriggerThreshold}</span><span class="setting-unit"></span></span>
          ...
          <div class="setting-row">
            ...
            <span class="setting-input-unit"><input type="range" class="setting-range" min="0" max="9" .value=${String(this.staticRenewThreshold)} @input=${t=>{const e=t.target;this._overrides.staticRenewThreshold=Number(e.value),e.nextElementSibling.textContent=e.value,this._fireDirty()}} /><span class="setting-value">${this.staticRenewThreshold}</span><span class="setting-unit"></span></span>
          ...
          <div class="setting-row">
            ...
            <span class="setting-input-unit"><input type="range" class="setting-range" .value=${String(this.staticOnDelay)} min="0" max="30" step="0.5" @input=${t=>{const e=t.target;this._overrides.staticOnDelay=Number(e.value),e.nextElementSibling.textContent=e.value,this._fireDirty()}} /><span class="setting-value">${this.staticOnDelay}</span><span class="setting-unit">s</span></span>
      ...
      <div class="settings-section">
        <div class="setting-group">
          ...
          <div class="setting-row">
            ...
            <label class="toggle-switch"><input type="checkbox" @change=${t=>{const e=t.target,i=e.dataset.entityKey;this._overrides.entities||(this._overrides.entities={}),this._overrides.entities[i]=e.checked,this._fireDirty()}} data-entity-key="room_target_count" ?checked=${i("room_target_count",!1)} /><span class="toggle-slider"></span></label>
        ...
        <div class="setting-group">
          ...
          <div class="setting-row">
            <label>${this.localize("entities.target_count")}</label>
            <label class="toggle-switch"><input type="checkbox" @change=${t=>{const e=t.target,i=e.dataset.entityKey;this._overrides.entities||(this._overrides.entities={}),this._overrides.entities[i]=e.checked,this._fireDirty()}} data-entity-key="zone_target_count" ?checked=${i("zone_target_count",!1)} /><span class="toggle-slider"></span></label>
    ...
    `}_fireStartCalibration(){this.dispatchEvent(new CustomEvent("start-calibration",{bubbles:!0,composed:!0}))}_fireCancel(){this._setupStep=null,this._wizardCorners=[null,null,null,null],this._wizardCornerIndex=0,this._wizardOffsetSide="",this._wizardOffsetFb="",this.dispatchEvent(new CustomEvent("wizard-cancel",{bubbles:!0,composed:!0}))}}fe.styles=[Xt,Qt,Yt,n`
      :host {
        display: block;
      }
