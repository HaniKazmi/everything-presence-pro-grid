...
`;class oe extends ct{constructor(){super(...arguments),this.furniture=[],this.selectedFurnitureId=null,this.hass=void 0,this.localize=t=>t,this.showCustomIconPicker=!1,this.customIconValue=""}render(){return this._renderFurnitureSidebar()}_renderFurnitureSidebar(){const t=this.furniture.find(t=>t.id===this.selectedFurnitureId);return W`
  ...
  `,t([pt({attribute:!1})],ge.prototype,"sensorState",void 0),t([pt({attribute:!1})],ge.prototype,"zoneState",void 0),t([pt({attribute:!1})],ge.prototype,"zoneConfigs",void 0),t([pt({attribute:!1})],ge.prototype,"perspective",void 0),t([pt({attribute:!1})],ge.prototype,"localize",void 0),t([gt()],ge.prototype,"_expandedSensorInfo",void 0),customElements.get("epp-live-sidebar")||customElements.define("epp-live-sidebar",ge);class me extends ct{constructor(){super(...arguments),this.sensorState={occupancy:!1,static_presence:!1,motion_presence:!1,target_presence:!1,illuminance:null,temperature:null,humidity:null,co2:null},this.targetAutoRange=!0,this.targetMaxDistance=6,this.staticAutoRange=!0,this.staticMinDistance=.3,this.staticMaxDistance=16,this.openAccordions=new Set,this.perspective=null,this.roomWidth=0,this.roomDepth=0,this.grid=new Uint8Array(0),this.saving=!1,this.dirty=!1,this.reportingConfig={},this.offsetsConfig={},this.localize=t=>t}render(){return W`
    ...
    `}_renderProtocolBanner(){const t=this._devices.find(t=>t.mac===this._selectedMac);if(!t||"compatible"===t.config_protocol_status)return j;const e=t.config_protocol_status,i="firmware_behind"===e,o="unavailable"===e?this._localize("protocol.unavailable"):i?this._localize("protocol.firmware_behind"):this._localize("protocol.firmware_ahead");return W`
		...
		`}async _updateFirmware(){if(this._selectedMac&&this.hass)try{await this.hass.callWS({type:"eppgrid/update_firmware",mac:this._selectedMac})}catch(t){console.error("Firmware update failed:",t)}}_renderConnectionBanner(){if(!this._deviceCtrl.connectionFailed)return j;const t=this._devices.find(t=>t.mac===this._selectedMac),e=t?.current_connection_count,i=null!=e?this._localize("connection.client_count",{count:e}):"";return W`
