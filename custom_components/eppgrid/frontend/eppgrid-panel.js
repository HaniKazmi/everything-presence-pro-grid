  ...
  `,t([pt({attribute:!1})],ge.prototype,"sensorState",void 0),t([pt({attribute:!1})],ge.prototype,"zoneState",void 0),t([pt({attribute:!1})],ge.prototype,"zoneConfigs",void 0),t([pt({attribute:!1})],ge.prototype,"perspective",void 0),t([pt({attribute:!1})],ge.prototype,"localize",void 0),t([gt()],ge.prototype,"_expandedSensorInfo",void 0),customElements.get("epp-live-sidebar")||customElements.define("epp-live-sidebar",ge);class me extends ct{constructor(){super(...arguments),this.sensorState={occupancy:!1,static_presence:!1,motion_presence:!1,target_presence:!1,illuminance:null,temperature:null,humidity:null,co2:null},this.targetAutoDistance=!0,this.targetMaxDistance=6,this.staticAutoDistance=!0,this.staticMinDistance=.3,this.staticMaxDistance=16,this.openAccordions=new Set,this.perspective=null,this.roomWidth=0,this.roomDepth=0,this.grid=new Uint8Array(0),this.saving=!1,this.dirty=!1,this.temperatureOffset=0,this.humidityOffset=0,this.illuminanceOffset=0,this.motionTimeout=5,this.staticTimeout=30,this.staticTriggerThreshold=3,this.staticRenewThreshold=3,this.staticOnDelay=0,this.entitiesConfig={},this.localize=t=>t}render(){return W`
    ...
    `}toggleAccordion(t){const e=this.openAccordions.has(t)?new Set:new Set([t]);this.openAccordions=e,this.dispatchEvent(new CustomEvent("accordion-toggle",{detail:e,bubbles:!0,composed:!0}))}renderSettingsSection(t){switch(t){case"detection":return this.renderDetectionRanges();case"sensitivity":return this.renderSensitivities();case"reporting":return this.renderEntities();default:return V}}renderEnvOffset(t,e,i,o,s,r,n,a,l){const c=this[`${i}Offset`]??0,h=null!=e?e-c:null,d=null!=h?(h+c).toFixed(a):"—";return W`
      <div class="setting-row">
        <label>${t}</label>
        <span class="setting-input-unit"><input type="range" class="setting-range" data-offset-key=${i} .value=${String(c)} min=${o} max=${s} step=${r} @input=${t=>{const e=t.target,i=parseFloat(e.value),o=null!=h?(h+i).toFixed(a):"—";e.nextElementSibling.textContent=o,this._fireDirty()}} /><span class="setting-value">${d}</span> ${n}</span>
        ${this.infoTip(l)}
      </div>
      ...
      <div class="settings-section">
        <div class="setting-group">
          ...
          <div class="setting-row">
            ...
            <label class="toggle-switch"><input type="checkbox" @change=${()=>this._fireDirty()} data-entity-key="room_occupancy" ?checked=${e("room_occupancy",!0)} /><span class="toggle-slider"></span></label>
            ${this.infoTip(this.localize("info.room_occupancy"))}
          </div>
          <div class="setting-row">
            <label>${this.localize("entities.static_presence")}</label>
            <label class="toggle-switch"><input type="checkbox" @change=${()=>this._fireDirty()} data-entity-key="room_static_presence" ?checked=${e("room_static_presence",!1)} /><span class="toggle-slider"></span></label>
            ${this.infoTip(this.localize("info.room_static"))}
          </div>
          <div class="setting-row">
            <label>${this.localize("entities.motion_presence")}</label>
            <label class="toggle-switch"><input type="checkbox" @change=${()=>this._fireDirty()} data-entity-key="room_motion_presence" ?checked=${e("room_motion_presence",!1)} /><span class="toggle-slider"></span></label>
            ${this.infoTip(this.localize("info.room_motion"))}
          </div>
          <div class="setting-row">
            <label>${this.localize("entities.target_presence")}</label>
            <label class="toggle-switch"><input type="checkbox" @change=${()=>this._fireDirty()} data-entity-key="room_target_presence" ?checked=${e("room_target_presence",!1)} /><span class="toggle-slider"></span></label>
            ${this.infoTip(this.localize("info.room_target_presence"))}
          </div>
          <div class="setting-row">
            <label>${this.localize("entities.target_count")}</label>
            <label class="toggle-switch"><input type="checkbox" @change=${()=>this._fireDirty()} data-entity-key="room_target_count" ?checked=${e("room_target_count",!1)} /><span class="toggle-slider"></span></label>
        ...
        <div class="setting-group">
          ...
          <div class="setting-row">
            ...
            <label class="toggle-switch"><input type="checkbox" @change=${()=>this._fireDirty()} data-entity-key="zone_presence" ?checked=${e("zone_presence",!0)} /><span class="toggle-slider"></span></label>
            ${this.infoTip(this.localize("info.zone_presence"))}
          </div>
          <div class="setting-row">
            <label>${this.localize("entities.target_count")}</label>
            <label class="toggle-switch"><input type="checkbox" @change=${()=>this._fireDirty()} data-entity-key="zone_target_count" ?checked=${e("zone_target_count",!1)} /><span class="toggle-slider"></span></label>
        ...
        <div class="setting-group">
          ...
          <div class="setting-row">
            ...
            <label class="toggle-switch"><input type="checkbox" @change=${()=>this._fireDirty()} data-entity-key="target_xy" ?checked=${e("target_xy",!1)} /><span class="toggle-slider"></span></label>
            ${this.infoTip(this.localize("info.xy"))}
          </div>
          <div class="setting-row">
            <label>${this.localize("entities.active")}</label>
            <label class="toggle-switch"><input type="checkbox" @change=${()=>this._fireDirty()} data-entity-key="target_active" ?checked=${e("target_active",!1)} /><span class="toggle-slider"></span></label>
        ...
        <div class="setting-group">
          ...
          <div class="setting-row">
            ...
            <label class="toggle-switch"><input type="checkbox" @change=${()=>this._fireDirty()} data-entity-key="env_illuminance" ?checked=${e("env_illuminance",!1)} /><span class="toggle-slider"></span></label>
            ${this.infoTip(this.localize("info.illuminance"))}
          </div>
          <div class="setting-row">
            <label>${this.localize("entities.humidity")}</label>
            <label class="toggle-switch"><input type="checkbox" @change=${()=>this._fireDirty()} data-entity-key="env_humidity" ?checked=${e("env_humidity",!1)} /><span class="toggle-slider"></span></label>
            ${this.infoTip(this.localize("info.humidity"))}
          </div>
          <div class="setting-row">
            <label>${this.localize("entities.temperature")}</label>
            <label class="toggle-switch"><input type="checkbox" @change=${()=>this._fireDirty()} data-entity-key="env_temperature" ?checked=${e("env_temperature",!1)} /><span class="toggle-slider"></span></label>
            ${this.infoTip(this.localize("info.temperature"))}
          </div>
          <div class="setting-row">
            <label>${this.localize("entities.co2")}</label>
            <label class="toggle-switch"><input type="checkbox" @change=${()=>this._fireDirty()} data-entity-key="env_co2" ?checked=${e("env_co2",!1)} /><span class="toggle-slider"></span></label>
