...
`;class ae extends ct{constructor(){super(...arguments),this.furniture=[],this.selectedFurnitureId=null,this.hass=void 0,this.localize=t=>t,this.showCustomIconPicker=!1,this.customIconValue=""}render(){return this._renderFurnitureSidebar()}_renderFurnitureSidebar(){const t=this.furniture.find(t=>t.id===this.selectedFurnitureId);return W`
		...
		`}_renderVisibleCells(t,e,i,o,s){const r=this.heatmapColors,n=this.occupancy,a=[];for(let l=i;l<=o;l++)for(let i=t;i<=e;i++){const t=l*$t+i,e=this.grid[t];let o=he(e,this.zoneConfigs),c="";if(Et(e)){const t=Mt(e);if(r){const e=r.get(t);e&&(o=`linear-gradient(${e}, ${e}), linear-gradient(${o}, ${o})`)}n[t]&&(c="box-shadow: inset 0 0 0 1px rgba(0,0,0,0.4);")}let h="";if(Et(e))if(Dt(e))h="background-image: repeating-linear-gradient(45deg, transparent, transparent 6px, rgba(60,60,60,0.7) 6px, rgba(60,60,60,0.7) 8px);";else{const t=At(e);t===wt?h="background-image: repeating-linear-gradient(-45deg, transparent, transparent 5px, #cc3333 5px, #cc3333 7px), repeating-linear-gradient(45deg, transparent, transparent 5px, #cc3333 5px, #cc3333 7px);":3===t?h="background-image: repeating-linear-gradient(-45deg, transparent, transparent 3px, #cc3333 3px, #cc3333 5px);":2===t?h="background-image: repeating-linear-gradient(-45deg, transparent, transparent 5px, #cc3333 5px, #cc3333 7px);":1===t&&(h="background-image: repeating-linear-gradient(-45deg, transparent, transparent 8px, #cc3333 8px, #cc3333 10px);")}a.push(W`
					<div
						class="cell"
		...
		`}_renderGridDimensions(){const t=fe(this.grid,this.roomWidth,this.perspective);return t?W`
  ...
  `,t([pt({attribute:!1})],ve.prototype,"sensorState",void 0),t([pt({attribute:!1})],ve.prototype,"zoneState",void 0),t([pt({attribute:!1})],ve.prototype,"zoneConfigs",void 0),t([pt({attribute:!1})],ve.prototype,"perspective",void 0),t([pt({attribute:!1})],ve.prototype,"localize",void 0),t([gt()],ve.prototype,"_expandedSensorInfo",void 0),customElements.get("epp-live-sidebar")||customElements.define("epp-live-sidebar",ve);class be extends ct{constructor(){super(...arguments),this.sensorState={occupancy:!1,static_presence:!1,motion_presence:!1,target_presence:!1,illuminance:null,temperature:null,humidity:null,co2:null},this.targetAutoDistance=!0,this.targetMaxDistance=6,this.staticAutoDistance=!0,this.staticMinDistance=.3,this.staticMaxDistance=16,this.openAccordions=new Set,this.perspective=null,this.roomWidth=0,this.roomDepth=0,this.grid=new Uint8Array(0),this.saving=!1,this.dirty=!1,this.temperatureOffset=0,this.humidityOffset=0,this.illuminanceOffset=0,this.motionTimeout=5,this.staticTimeout=30,this.staticTriggerThreshold=3,this.staticRenewThreshold=3,this.staticOnDelay=0,this.entitiesConfig={},this.logLevels={},this.bluetoothEnabled=!1,this.co2Enabled=!1,this.ledMode="Manual Control",this.ledBrightness=1,this.ledPresenceColor="#CC33FF",this.relayTriggerMode="disabled",this.relayContactMode="no",this.targetUpdateRateMs=1e3,this.zoneUpdateRateMs=1e3,this._overrides={},this.localize=t=>t}render(){return W`
    ...
    ><ha-icon icon="mdi:help-circle-outline"></ha-icon><span class="setting-info-tooltip">${t}</span></button>`}renderDetectionRanges(){const t=ge(this.roomWidth,this.roomDepth,this.perspective,this.grid),e=fe(this.grid,this.roomWidth,this.perspective),i=t>0?Math.min(t,6):6,o=t>0?Math.min(t,16):16,s=this.targetAutoDistance?i:this.targetMaxDistance,r=this.staticAutoDistance?o:this.staticMaxDistance,n="opacity: 0.5; pointer-events: none;";return W`
    ...
    `}renderEntities(){const t=this.entitiesConfig||{},e=this._overrides.entities||{},i=(i,o)=>e[i]??t[i]??o,o=t=>{const e=t.target,i=e.dataset.entityKey;this._overrides.entities||(this._overrides.entities={}),this._overrides.entities[i]=e.checked,this._fireDirty()},s=this._overrides,r=i("zone_presence",!0)||i("zone_target_count",!1),n=i("target_xy",!1)||i("target_active",!1)||i("target_signal",!1)||i("target_zone",!1)||i("target_count",!1),a=[{value:"200",label:"5 Hz"},{value:"500",label:"2 Hz"},{value:"1000",label:"1 Hz"},{value:"2000",label:"0.5 Hz"}];return W`
      <div class="settings-section">
        <div class="setting-group">
    ...
    `}renderLogging(){const t=["None","Error","Warning","Info","Debug"],e=[{key:"system",label:"settings.log_system",tip:"info.log_system",show:!0},{key:"epp",label:"settings.log_epp",tip:"info.log_epp",show:!0},{key:"led",label:"settings.log_led",tip:"info.log_led",show:!0},{key:"networking",label:"settings.log_networking",tip:"info.log_networking",show:!0},{key:"ble",label:"settings.log_ble",tip:"info.log_ble",show:this.bluetoothEnabled},{key:"co2",label:"settings.log_co2",tip:"info.log_co2",show:this.co2Enabled}];return W`
      <div class="settings-section">
        <div class="setting-group">
          ${e.filter(t=>t.show).map(e=>{const i=(this._overrides.logLevels||{})[e.key]??this.logLevels[e.key]??"None";return W`
              <div class="setting-row">
    ...
    `}_renderWizardCorners(){const t=this._wizardCornerIndex,e=this.rawTargets.filter(t=>null!=t.raw_x&&null!=t.raw_y),i=e.length>0,o=e.length>1,s=this._wizardCorners.every(t=>null!==t),r=It[t]||"",[n,a]=Ot[t]||["",""];return W`
      <div class="wizard-card">
        ...
        <div class="corner-progress">
          ${It.map((e,i)=>{const o=!!this._wizardCorners[i],s=i<3,r=i<t;return W`
                <span
    ...
    `}_renderMiniSensorView(){const t=Wt,e=Ct,i=200,o=-t,s=e*Math.cos(Gt),r=`M 0 0 L ${o} ${s} A 6000 6000 0 0 0 ${t} ${s} Z`,n=[2e3,4e3].map(t=>{const e=t*Math.sin(Gt),i=t*Math.cos(Gt);return`M ${-e} ${i} A ${t} ${t} 0 0 0 ${e} ${i}`});return W`
    ...
    `],t([pt({attribute:!1})],ye.prototype,"hass",void 0),t([pt({type:String})],ye.prototype,"selectedMac",void 0),t([pt({attribute:!1})],ye.prototype,"rawTargets",void 0),t([pt({attribute:!1})],ye.prototype,"sensorState",void 0),t([pt({attribute:!1})],ye.prototype,"devices",void 0),t([pt({attribute:!1})],ye.prototype,"localize",void 0),t([pt({type:Number})],ye.prototype,"initialRoomWidth",void 0),t([pt({type:Number})],ye.prototype,"initialRoomDepth",void 0),t([pt({type:String})],ye.prototype,"mode",void 0),t([gt()],ye.prototype,"_setupStep",void 0),t([gt()],ye.prototype,"_wizardSaving",void 0),t([gt()],ye.prototype,"_wizardCornerIndex",void 0),t([gt()],ye.prototype,"_wizardCorners",void 0),t([gt()],ye.prototype,"_wizardRoomWidth",void 0),t([gt()],ye.prototype,"_wizardRoomDepth",void 0),t([gt()],ye.prototype,"_wizardCapturing",void 0),t([gt()],ye.prototype,"_wizardCaptureProgress",void 0),t([gt()],ye.prototype,"_wizardCapturePaused",void 0),t([gt()],ye.prototype,"_wizardOffsetSide",void 0),t([gt()],ye.prototype,"_wizardOffsetFb",void 0),customElements.get("epp-wizard")||customElements.define("epp-wizard",ye);class xe extends ct{constructor(){super(...arguments),this.overlayMode=null,this.interferenceLevel=1,this.localize=t=>t}render(){return W`
			<div class="overlay-scroll-area">
				...
				>
					...
					${"interference"===this.overlayMode?W`
	...
	`,t([pt({attribute:!1})],xe.prototype,"overlayMode",void 0),t([pt({type:Number})],xe.prototype,"interferenceLevel",void 0),t([pt({attribute:!1})],xe.prototype,"localize",void 0),customElements.get("epp-overlay-sidebar")||customElements.define("epp-overlay-sidebar",xe);const we={normal:{trigger:5,renew:3,timeout:10,handoff_timeout:3},thoroughfare:{trigger:3,renew:2,timeout:3,handoff_timeout:1},rest:{trigger:7,renew:1,timeout:30,handoff_timeout:10}},$e=["#E69F00","#56B4E9","#009E73","#F0E442","#0072B2","#D55E00","#CC79A7"];function ze(t,e,i,o,s,r,n){if(0===t){const t=we[i]||we.normal;return"custom"===i?{trigger:o,renew:s,timeout:r,handoffTimeout:n}:{trigger:t.trigger,renew:t.renew,timeout:t.timeout,handoffTimeout:t.handoff_timeout}}if(t>0&&t<=e.length){const i=e[t-1];if(i){const t=we[i.type]||we.normal;return"custom"===i.type?{trigger:i.trigger??t.trigger,renew:i.renew??t.renew,timeout:i.timeout??t.timeout,handoffTimeout:i.handoff_timeout??t.handoff_timeout}:{trigger:t.trigger,renew:t.renew,timeout:t.timeout,handoffTimeout:t.handoff_timeout}}}return{trigger:5,renew:3,timeout:10,handoffTimeout:3}}class ke extends ct{constructor(){super(...arguments),this.zoneConfigs=[],this.activeZone=null,this.roomType="normal",this.roomTrigger=we.normal.trigger,this.roomRenew=we.normal.renew,this.roomTimeout=we.normal.timeout,this.roomHandoffTimeout=we.normal.handoff_timeout,this.localZoneState=new Map,this.localize=t=>t}render(){return this._renderZoneSidebar()}_renderZoneSidebar(){return W`
		...
		`}_renderZoneTypeControls(t,e){const i="custom"===t.type,o=we[t.type]||we.normal,s=t.trigger??o.trigger,r=t.renew??o.renew,n=t.timeout??o.timeout,a=t.handoff_timeout??o.handoff_timeout,l=`width: 100%; display: flex; align-items: center; gap: 4px; font-size: 12px; opacity: ${i?1:.5};`;return W`
			<div
				class="zone-item-row zone-settings-row"
				style="flex-wrap: wrap; gap: 3px; padding: 4px 8px;"
			>
    ...
    `}_toggleAccordion(t){this._openAccordions=this._openAccordions.has(t)?new Set:new Set([t])}_getSensorRoomPosition(){return pe(this._perspective)}_autoDetectionRange(){return ge(this._roomWidth,this._roomDepth,this._perspective,this._grid)}_renderSettings(){return W`
      <div class="panel">
        ${this._renderHeader()}
        <epp-settings-view
          .sensorState=${this._sensorState}
        ...
        <div class="editor-layout">
          ...
          <div class="zone-sidebar scrollable">
            ...
            ${"zones"===this._sidebarTab?W`<epp-zone-sidebar
                    ...
                    @dirty=${()=>{this._dirty=!0}}
                  ></epp-zone-sidebar>`:"overlays"===this._sidebarTab?W`<epp-overlay-sidebar
                  ...
                  ></epp-overlay-sidebar>`:W`<epp-furniture-sidebar
                    .furniture=${this._furniture}
                    .selectedFurnitureId=${this._selectedFurnitureId}
                    .hass=${this.hass}
                    .localize=${this._localize}
