...
`,Mt=[{step:"removing_old_device",label:"Removing old device"},{step:"downloading_firmware",label:"Downloading firmware"},{step:"flashing",label:"Flashing firmware"},{step:"waiting_for_reboot",label:"Waiting for reboot"},{step:"adding_to_esphome",label:"Adding to ESPHome"},{step:"complete",label:"Complete"}],St=Mt.map(t=>t.step);let Dt=class extends ct{constructor(){super(...arguments),this.flashableDevices=[],this.loading=!1,this.otaProgress=null,this.flashingMac=null,this._selectedVariant="wifi",this._confirmDevice=null,this._hasWebSerial="undefined"!=typeof navigator&&"serial"in navigator,this._wifiNetworks=[],this._wifiScanning=!1,this._selectedSsid="",this._manualSsid=!1,this._wifiPassword="",this._wifiConnected=!1,this._deviceIp=null,this._showWifiProvisioning=!1}_dispatchFlashOta(){this._confirmDevice&&(this.dispatchEvent(new CustomEvent("flash-ota",{detail:{mac:this._confirmDevice.mac,variant:this._selectedVariant},bubbles:!0,composed:!0})),this._confirmDevice=null)}_dispatchUsbConnect(){this.dispatchEvent(new CustomEvent("usb-connect",{bubbles:!0,composed:!0}))}_dispatchFlashComplete(){this.dispatchEvent(new CustomEvent("flash-complete",{bubbles:!0,composed:!0}))}_dispatchWifiScan(){this.dispatchEvent(new CustomEvent("wifi-scan",{bubbles:!0,composed:!0}))}_dispatchWifiProvision(){this.dispatchEvent(new CustomEvent("wifi-provision",{detail:{ssid:this._selectedSsid,password:this._wifiPassword},bubbles:!0,composed:!0}))}_dispatchWifiComplete(){this.dispatchEvent(new CustomEvent("wifi-complete",{bubbles:!0,composed:!0}))}_renderLoading(){return G`<div class="flasher-loading">Loading devices...</div>`}_renderOtaProgress(t){const e=St.indexOf(t.step),i="failed"===t.status||"timeout"===t.status,o="success"===t.status;return G`
      <div class="progress-steps">
        ${Mt.map((s,r)=>{const n=s.step===t.step,a=n&&i;let l="progress-step",c="○";return a?(l+=" step-error",c="✗"):r<e||n&&o?(l+=" step-done",c="✓"):n&&(l+=" step-active",c="⟳"),G`
            <div class="${l}">
    ...
    `}_renderConfirmDialog(t){return G`
      <div class="confirm-dialog">
        <div class="confirm-card">
          ...
          <p>
            Flash EPP Grid firmware to <strong>${t.name}</strong>?
    ...
    `}_renderWifiProvisioning(){if(this._wifiConnected)return G`
        <div class="wifi-provisioning">
          ...
          <p>
            ...
            ${this._deviceIp?G` — IP: <strong>${this._deviceIp}</strong>`:j}
          </p>
          <div class="confirm-actions">
            <button
      ...
      <div class="wifi-provisioning">
        ...
        <div class="wifi-scan-row">
          ...
          ${this._wifiScanning?G`<span class="wifi-scanning">Scanning...</span>`:j}
        </div>
              ...
              <div class="device-list">
                ${t.map(t=>G`
                    <div class="device-row">
                      ...
                      >
                        ${"original"===t.firmware_type?"Original":"EPP Grid"}
                      </span>
                      <button
                        class="flash-btn"
 ...
 */class Lt extends Rt{}Lt.directiveName="unsafeSVG",Lt.resultType=2;const It=Pt(Lt),Ot=20,Nt=20,Ft=400,Ut=300,Wt=6e3,Gt=t=>!!(1&t),Zt=t=>t>>1&7,Vt=(t,e)=>-15&t|(7&e)<<1,jt=t=>!!(16&t),Xt=t=>t>>5&7,Yt=(t,e)=>e>0?-17&(-225&t|(7&e)<<5):-225&t;function qt(t){let e=Ot,i=0,o=Nt,s=0;for(let r=0;r<Ft;r++)if(Gt(t[r])){const t=r%Ot,n=Math.floor(r/Ot);t<e&&(e=t),t>i&&(i=t),n<o&&(o=n),n>s&&(s=n)}return{minCol:Math.max(0,e-1),maxCol:Math.min(19,i+1),minRow:Math.max(0,o-1),maxRow:Math.min(19,s+1)}}function Kt(t){let e=Ot,i=0,o=Nt,s=0;for(let r=0;r<Ft;r++)if(Gt(t[r])){const t=r%Ot,n=Math.floor(r/Ot);t<e&&(e=t),t>i&&(i=t),n<o&&(o=n),n>s&&(s=n)}return{minCol:e,maxCol:i,minRow:o,maxRow:s}}function Jt(t,e){const i=new Uint8Array(Ft),o=Math.ceil(t/Ut),s=Math.ceil(e/Ut),r=Math.floor((Ot-o)/2);for(let t=0;t<Nt;t++)for(let e=0;e<Ot;e++){e>=r&&e<r+o&&t>=0&&t<0+s&&(i[t*Ot+e]=1)}return i}const Qt={armchair:{viewBox:"0 0 256 256",content:'<rect x="16" y="16" width="224" height="224" rx="16" stroke="black" stroke-width="12" fill="none"/><rect x="16" y="16" width="224" height="48" rx="8" stroke="black" stroke-width="12" fill="none"/><rect x="16" y="64" width="48" height="176" rx="8" stroke="black" stroke-width="12" fill="none"/><rect x="192" y="64" width="48" height="176" rx="8" stroke="black" stroke-width="12" fill="none"/><rect x="64" y="64" width="128" height="176" rx="8" stroke="black" stroke-width="8" fill="none"/>'},bath:{viewBox:"0 0 600 300",content:'<rect x="50" y="50" width="500" height="200" rx="40" stroke="black" stroke-width="8" fill="none"/><path d="M 100 220 C 100 240, 500 240, 500 220" stroke="black" stroke-width="8" fill="none"/><rect x="70" y="70" width="30" height="20" stroke="black" stroke-width="8" fill="none"/><rect x="80" y="90" width="10" height="20" stroke="black" stroke-width="8" fill="none"/><circle cx="510" cy="150" r="10" stroke="black" stroke-width="8" fill="none"/>'},"bed-double":{viewBox:"0 0 512 512",content:'<rect x="0" y="0" width="512" height="512" rx="16" stroke="black" stroke-width="16" fill="none"/><path d="M0 64C0 46.3269 16.3269 32 32 32H480C497.673 32 512 46.3269 512 64V128C512 145.673 497.673 160 480 160H32C16.3269 160 0 145.673 0 128V64Z" stroke="black" stroke-width="16" fill="none"/><rect x="32" y="32" width="208" height="96" rx="8" stroke="black" stroke-width="16" fill="none"/><rect x="272" y="32" width="208" height="96" rx="8" stroke="black" stroke-width="16" fill="none"/><rect x="16" y="144" width="480" height="336" rx="8" stroke="black" stroke-width="16" fill="none"/><line x1="16" y1="256" x2="496" y2="256" stroke="#D0D0D0" stroke-width="8"/><line x1="16" y1="368" x2="496" y2="368" stroke="#D0D0D0" stroke-width="8"/>'},"bed-single":{viewBox:"0 0 256 512",content:'<rect x="0" y="0" width="256" height="512" rx="16" stroke="black" stroke-width="16" fill="none"/><path d="M0 64C0 46.3269 16.3269 32 32 32H224C241.673 32 256 46.3269 256 64V128C256 145.673 241.673 160 224 160H32C16.3269 160 0 145.673 0 128V64Z" stroke="black" stroke-width="16" fill="none"/><rect x="32" y="32" width="192" height="96" rx="8" stroke="black" stroke-width="16" fill="none"/><rect x="16" y="144" width="224" height="336" rx="8" stroke="black" stroke-width="16" fill="none"/><line x1="16" y1="256" x2="240" y2="256" stroke="#D0D0D0" stroke-width="8"/><line x1="16" y1="368" x2="240" y2="368" stroke="#D0D0D0" stroke-width="8"/>'},"door-left":{viewBox:"0 0 256 256",content:'<rect x="0" y="210" width="80" height="20" fill="black"/><rect x="60" y="60" width="20" height="150" fill="black"/><rect x="200" y="210" width="56" height="20" fill="black"/><path d="M 80 60 A 150 150 0 0 1 200 210" stroke="black" stroke-width="3" fill="none"/>'},"door-right":{viewBox:"0 0 256 256",content:'<rect x="176" y="210" width="80" height="20" fill="black"/><rect x="176" y="60" width="20" height="150" fill="black"/><rect x="0" y="210" width="56" height="20" fill="black"/><path d="M 176 60 A 150 150 0 0 0 56 210" stroke="black" stroke-width="3" fill="none"/>'},"floor-lamp":{viewBox:"0 0 256 256",content:'<circle cx="128" cy="128" r="96" stroke="black" stroke-width="16" fill="none"/><circle cx="128" cy="128" r="80" stroke="black" stroke-width="8" fill="none"/><circle cx="128" cy="128" r="16" fill="black"/><line x1="128" y1="112" x2="128" y2="48" stroke="black" stroke-width="8"/><circle cx="128" cy="48" r="8" fill="black"/><path d="M 64 64 A 128 128 0 0 1 192 64" stroke="black" stroke-width="8" stroke-dasharray="8 8"/>'},oven:{viewBox:"0 0 256 256",content:'<rect x="0" y="0" width="256" height="256" rx="16" stroke="black" stroke-width="16" fill="none"/><line x1="0" y1="224" x2="256" y2="224" stroke="black" stroke-width="16"/><circle cx="64" cy="64" r="40" stroke="black" stroke-width="16" fill="none"/><circle cx="64" cy="64" r="16" fill="black"/><circle cx="192" cy="64" r="40" stroke="black" stroke-width="16" fill="none"/><circle cx="192" cy="64" r="16" fill="black"/><circle cx="64" cy="192" r="40" stroke="black" stroke-width="16" fill="none"/><circle cx="64" cy="192" r="16" fill="black"/><circle cx="192" cy="192" r="40" stroke="black" stroke-width="16" fill="none"/><circle cx="192" cy="192" r="16" fill="black"/><rect x="32" y="240" width="192" height="16" rx="4" stroke="black" stroke-width="8" fill="black"/>'},plant:{viewBox:"0 0 256 256",content:'<circle cx="128" cy="128" r="96" stroke="black" stroke-width="16" fill="none"/><circle cx="128" cy="128" r="80" fill="none"/><g transform="translate(128 128)"><path d="M 0 0 C 0 -64, 40 -80, 0 -96 C -40 -80, 0 -64, 0 0 Z" fill="none" stroke="black" stroke-width="12"/><path d="M 0 0 C 0 -64, 40 -80, 0 -96 C -40 -80, 0 -64, 0 0 Z" transform="rotate(72)" fill="none" stroke="black" stroke-width="12"/><path d="M 0 0 C 0 -64, 40 -80, 0 -96 C -40 -80, 0 -64, 0 0 Z" transform="rotate(144)" fill="none" stroke="black" stroke-width="12"/><path d="M 0 0 C 0 -64, 40 -80, 0 -96 C -40 -80, 0 -64, 0 0 Z" transform="rotate(216)" fill="none" stroke="black" stroke-width="12"/><path d="M 0 0 C 0 -64, 40 -80, 0 -96 C -40 -80, 0 -64, 0 0 Z" transform="rotate(288)" fill="none" stroke="black" stroke-width="12"/></g>'},shower:{viewBox:"0 0 256 256",content:'<path d="M 32 32 H 224 V 224 H 32 Z" stroke="black" stroke-width="16" fill="none"/><line x1="32" y1="32" x2="224" y2="224" stroke="black" stroke-width="8" stroke-dasharray="8 8"/><line x1="224" y1="32" x2="32" y2="224" stroke="black" stroke-width="8" stroke-dasharray="8 8"/><circle cx="128" cy="200" r="16" stroke="black" stroke-width="16" fill="none"/>'},"sofa-two-seater":{viewBox:"0 0 400 200",content:'<rect x="8" y="8" width="384" height="184" rx="12" stroke="black" stroke-width="10" fill="none"/><rect x="8" y="8" width="384" height="48" rx="8" stroke="black" stroke-width="10" fill="none"/><rect x="24" y="56" width="172" height="128" rx="8" stroke="black" stroke-width="8" fill="none"/><rect x="204" y="56" width="172" height="128" rx="8" stroke="black" stroke-width="8" fill="none"/>'},"sofa-three-seater":{viewBox:"0 0 560 200",content:'<rect x="8" y="8" width="544" height="184" rx="12" stroke="black" stroke-width="10" fill="none"/><rect x="8" y="8" width="544" height="48" rx="8" stroke="black" stroke-width="10" fill="none"/><rect x="24" y="56" width="160" height="128" rx="8" stroke="black" stroke-width="8" fill="none"/><rect x="200" y="56" width="160" height="128" rx="8" stroke="black" stroke-width="8" fill="none"/><rect x="376" y="56" width="160" height="128" rx="8" stroke="black" stroke-width="8" fill="none"/>'},"table-dining-room":{viewBox:"0 0 600 400",content:'<rect x="150" y="100" width="300" height="200" stroke="black" stroke-width="8" fill="none" rx="10"/><rect x="80" y="150" width="60" height="100" stroke="black" stroke-width="8" fill="none" rx="5"/><rect x="460" y="150" width="60" height="100" stroke="black" stroke-width="8" fill="none" rx="5"/><rect x="175" y="30" width="100" height="60" stroke="black" stroke-width="8" fill="none" rx="5"/><rect x="325" y="30" width="100" height="60" stroke="black" stroke-width="8" fill="none" rx="5"/><rect x="175" y="310" width="100" height="60" stroke="black" stroke-width="8" fill="none" rx="5"/><rect x="325" y="310" width="100" height="60" stroke="black" stroke-width="8" fill="none" rx="5"/>'},"table-dining-room-round":{viewBox:"0 0 400 400",content:'<circle cx="200" cy="200" r="100" stroke="black" stroke-width="8" fill="none"/><rect x="150" y="30" width="100" height="60" stroke="black" stroke-width="8" fill="none" rx="5"/><rect x="150" y="310" width="100" height="60" stroke="black" stroke-width="8" fill="none" rx="5"/><rect x="30" y="150" width="60" height="100" stroke="black" stroke-width="8" fill="none" rx="5"/><rect x="310" y="150" width="60" height="100" stroke="black" stroke-width="8" fill="none" rx="5"/>'},television:{viewBox:"0 0 256 64",content:'<line x1="0" y1="56" x2="256" y2="56" stroke="black" stroke-width="16"/><rect x="32" y="16" width="192" height="40" rx="4" stroke="black" stroke-width="16" fill="none"/><rect x="40" y="24" width="176" height="24" rx="2" stroke="black" stroke-width="8" fill="none"/>'},toilet:{viewBox:"0 0 300 400",content:'<rect x="75" y="30" width="150" height="80" rx="10" stroke="black" stroke-width="8" fill="none"/><path d="M 75 110 C 75 110, 50 160, 50 210 C 50 310, 125 360, 150 360 C 175 360, 250 310, 250 210 C 250 160, 225 110, 225 110 Z" stroke="black" stroke-width="8" fill="none"/><path d="M 100 150 C 100 150, 75 190, 75 220 C 75 300, 125 340, 150 340 C 175 340, 225 300, 225 220 C 225 190, 200 150, 200 150 Z" stroke="black" stroke-width="8" fill="none"/><circle cx="150" cy="70" r="15" stroke="black" stroke-width="8" fill="none"/>'}},te=[{type:"svg",icon:"armchair",label:"furniture.armchair",defaultWidth:800,defaultHeight:800},{type:"svg",icon:"bath",label:"furniture.bath",defaultWidth:1700,defaultHeight:700},{type:"svg",icon:"bed-double",label:"furniture.double_bed",defaultWidth:1600,defaultHeight:2e3},{type:"svg",icon:"bed-single",label:"furniture.single_bed",defaultWidth:900,defaultHeight:2e3},{type:"svg",icon:"door-left",label:"furniture.door_left_swing",defaultWidth:800,defaultHeight:800},{type:"svg",icon:"door-right",label:"furniture.door_right_swing",defaultWidth:800,defaultHeight:800},{type:"svg",icon:"table-dining-room",label:"furniture.dining_table",defaultWidth:1600,defaultHeight:900},{type:"svg",icon:"table-dining-room-round",label:"furniture.round_table",defaultWidth:1e3,defaultHeight:1e3},{type:"svg",icon:"floor-lamp",label:"furniture.lamp",defaultWidth:400,defaultHeight:400},{type:"svg",icon:"oven",label:"furniture.oven_stove",defaultWidth:600,defaultHeight:600},{type:"svg",icon:"plant",label:"furniture.plant",defaultWidth:400,defaultHeight:400},{type:"svg",icon:"shower",label:"furniture.shower",defaultWidth:900,defaultHeight:900},{type:"svg",icon:"sofa-two-seater",label:"furniture.sofa_2_seat",defaultWidth:1600,defaultHeight:800},{type:"svg",icon:"sofa-three-seater",label:"furniture.sofa_3_seat",defaultWidth:2400,defaultHeight:800},{type:"svg",icon:"television",label:"furniture.tv",defaultWidth:1200,defaultHeight:200},{type:"svg",icon:"toilet",label:"furniture.toilet",defaultWidth:400,defaultHeight:700},{type:"icon",icon:"mdi:countertop",label:"furniture.counter",defaultWidth:2e3,defaultHeight:600,lockAspect:!1},{type:"icon",icon:"mdi:cupboard",label:"furniture.cupboard",defaultWidth:1e3,defaultHeight:500,lockAspect:!1},{type:"icon",icon:"mdi:desk",label:"furniture.desk",defaultWidth:1400,defaultHeight:700,lockAspect:!1},{type:"icon",icon:"mdi:fridge",label:"furniture.fridge",defaultWidth:700,defaultHeight:700,lockAspect:!0},{type:"icon",icon:"mdi:speaker",label:"furniture.speaker",defaultWidth:300,defaultHeight:300,lockAspect:!0},{type:"icon",icon:"mdi:window-open-variant",label:"furniture.window",defaultWidth:1e3,defaultHeight:150,lockAspect:!1}],ee=["corners.front_left","corners.front_right","corners.back_right","corners.back_left"],ie=[["corners.left_wall","corners.front_wall"],["corners.right_wall","corners.front_wall"],["corners.right_wall","corners.back_wall"],["corners.left_wall","corners.back_wall"]],oe=["#2196F3","#FF5722","#4CAF50"],se=100,re=Math.PI/3,ne=Wt*Math.sin(Math.PI/3);function ae(t,e){return t/Ut*(e+1)}function le(t,e){return t/(e+1)*Ut}function ce(t,e,i){const o=i-e;return Math.round((t+o+360)%360)}class he extends ct{constructor(){super(...arguments),this.furniture=[],this.selectedFurnitureId=null,this.roomWidth=3e3,this.cellPx=28,this.minCol=0,this.minRow=0,this.visCols=20,this.visRows=20,this.sidebarTab="zones",this.localize=t=>t}_mmToPx(t){return ae(t,this.cellPx)}_fireEvent(t,e){this.dispatchEvent(new CustomEvent(t,{bubbles:!0,composed:!0,detail:e}))}_onItemPointerDown(t,e){this._fireEvent("furniture-select",e),this._fireEvent("furniture-pointer-down",{e:t,id:e,type:"move"})}_onResizePointerDown(t,e,i){this._fireEvent("furniture-pointer-down",{e:t,id:e,type:"resize",handle:i})}_onRotatePointerDown(t,e){this._fireEvent("furniture-pointer-down",{e:t,id:e,type:"rotate"})}_onDeletePointerDown(t,e){t.stopPropagation(),this._fireEvent("furniture-delete",e)}render(){if(!this.furniture.length)return j;const t=Math.ceil(this.roomWidth/Ut),e=Math.floor((Ot-t)/2),i=this.cellPx+1,o="furniture"===this.sidebarTab;return G`
			<div class="furniture-overlay ${o?"":"non-interactive"}">
				${this.furniture.map(t=>{const o=(e-this.minCol)*i+this._mmToPx(t.x),s=(0-this.minRow)*i+this._mmToPx(t.y),r=this._mmToPx(t.width),n=this._mmToPx(t.height),a=this.selectedFurnitureId===t.id;return G`
						...
						>
							${"svg"===t.type&&Qt[t.icon]?Z`<svg viewBox="${Qt[t.icon].viewBox}" preserveAspectRatio="none" class="furn-svg">
										${It(Qt[t.icon].content)}
	...
	`,t([gt({attribute:!1})],he.prototype,"furniture",void 0),t([gt({attribute:!1})],he.prototype,"selectedFurnitureId",void 0),t([gt({type:Number})],he.prototype,"roomWidth",void 0),t([gt({type:Number})],he.prototype,"cellPx",void 0),t([gt({type:Number})],he.prototype,"minCol",void 0),t([gt({type:Number})],he.prototype,"minRow",void 0),t([gt({type:Number})],he.prototype,"visCols",void 0),t([gt({type:Number})],he.prototype,"visRows",void 0),t([gt({attribute:!1})],he.prototype,"sidebarTab",void 0),t([gt({attribute:!1})],he.prototype,"localize",void 0),customElements.get("epp-furniture-overlay")||customElements.define("epp-furniture-overlay",he);class de extends ct{constructor(){super(...arguments),this.furniture=[],this.selectedFurnitureId=null,this.hass=void 0,this.localize=t=>t,this.showCustomIconPicker=!1,this.customIconValue=""}render(){return this._renderFurnitureSidebar()}_renderFurnitureSidebar(){const t=this.furniture.find(t=>t.id===this.selectedFurnitureId);return G`
			...
			<div class="furn-catalog">
				${te.map(t=>G`
						<button class="furn-sticker" @click=${()=>this._fireAdd(t)}>
							${"svg"===t.type&&Qt[t.icon]?Z`<svg viewBox="${Qt[t.icon].viewBox}" class="furn-sticker-svg">
										${It(Qt[t.icon].content)}
		...
		`],t([gt({attribute:!1})],de.prototype,"furniture",void 0),t([gt({attribute:!1})],de.prototype,"selectedFurnitureId",void 0),t([gt({attribute:!1})],de.prototype,"hass",void 0),t([gt({attribute:!1})],de.prototype,"localize",void 0),t([gt({attribute:!1})],de.prototype,"showCustomIconPicker",void 0),t([gt({attribute:!1})],de.prototype,"customIconValue",void 0),customElements.get("epp-furniture-sidebar")||customElements.define("epp-furniture-sidebar",de);const ue=Wt*Math.sin(Math.PI/3);function ge(t,e){if(!Gt(t))return"var(--secondary-background-color, #e0e0e0)";const i=Zt(t);if(i>0&&i<=7){const t=e[i-1];if(t)return t.color}return"var(--card-background-color, #fff)"}function fe(t){return{r:parseInt(t.slice(1,3),16),g:parseInt(t.slice(3,5),16),b:parseInt(t.slice(5,7),16)}}function me(t,e,i){const o=t[6]*e+t[7]*i+1;return{x:(t[0]*e+t[1]*i+t[2])/o,y:(t[3]*e+t[4]*i+t[5])/o}}function _e(t){return t?me(t,0,0):null}function ve(t,e,i,o){if(t<=0||e<=0)return 0;const s=_e(i);if(s){const e=Math.ceil(t/Ut),i=Math.floor((Ot-e)/2);let r=0;const n=Kt(o);for(let t=n.minRow;t<=n.maxRow;t++)for(let e=n.minCol;e<=n.maxCol;e++){if(!Gt(o[t*Ot+e]))continue;const n=(t+.5)*Ut,a=(e-i+.5)*Ut-s.x,l=n-s.y,c=Math.sqrt(a*a+l*l);c>r&&(r=c)}if(r>0){const t=r/1e3;return Math.ceil(2*t)/2}}const r=Math.max(t,e)/1e3;return Math.ceil(2*r)/2}function be(t){if(0===t.length)return 0;const e=[...t].sort((t,e)=>t-e),i=Math.floor(e.length/2);return e.length%2?e[i]:(e[i-1]+e[i])/2}function ye(t,e,i){const o=Kt(t);if(o.minCol>o.maxCol)return null;const s=o.maxCol-o.minCol+1,r=o.maxRow-o.minRow+1,n=s*Ut,a=r*Ut,l=_e(i),c=Math.ceil(e/Ut),h=Math.floor((Ot-c)/2),d=l?l.x:n/2,p=l?l.y:0;let u=0;for(let e=0;e<Ft;e++){if(!Gt(t[e]))continue;const i=e%Ot,o=Math.floor(e/Ot),s=(i-h+.5)*Ut-d,r=(o+.5)*Ut-p,n=s*s+r*r;n>u&&(u=n)}return{widthM:(n/1e3).toFixed(1),depthM:(a/1e3).toFixed(1),furthestM:(Math.sqrt(u)/1e3).toFixed(1)}}class xe extends ct{constructor(){super(...arguments),this.grid=new Uint8Array(0),this.zoneConfigs=[],this.targets=[],this.roomWidth=0,this.roomDepth=0,this.perspective=null,this.furniture=[],this.selectedFurnitureId=null,this.sidebarTab="zones",this.editable=!1,this.activeZone=null,this.showHitCounts=!1,this.occupancy={},this.targetPrevXY=[],this.heatmapColors=null,this.localize=t=>t,this.dismissedTargets=new Map,this.maxGridPx=480,this.frozenBounds=null}render(){const t=this.frozenBounds??qt(this.grid),e=t.minCol>t.maxCol,i=e?0:t.minCol,o=e?19:t.maxCol,s=e?0:t.minRow,r=t.maxRow,n=o-i+1,a=r-s+1,l=Math.min(Math.floor(this.maxGridPx/n),Math.floor(this.maxGridPx/a),32);return G`
		...
		`}_renderVisibleCells(t,e,i,o,s){const r=this.heatmapColors,n=this.occupancy,a=[];for(let l=i;l<=o;l++)for(let i=t;i<=e;i++){const t=l*Ot+i,e=this.grid[t];let o=ge(e,this.zoneConfigs),c="";if(Gt(e)){const t=Zt(e);if(r){const e=r.get(t);e&&(o=`linear-gradient(${e}, ${e}), linear-gradient(${o}, ${o})`)}n[t]&&(c="box-shadow: inset 0 0 0 1px rgba(0,0,0,0.4);")}let h="";if(Gt(e))if(jt(e))h="background-image: repeating-linear-gradient(45deg, transparent, transparent 6px, rgba(60,60,60,0.7) 6px, rgba(60,60,60,0.7) 8px);";else{const t=Xt(e);7===t?h="background-image: repeating-linear-gradient(-45deg, transparent, transparent 5px, #cc3333 5px, #cc3333 7px), repeating-linear-gradient(45deg, transparent, transparent 5px, #cc3333 5px, #cc3333 7px);":t>0&&(h="background-image: repeating-linear-gradient(-45deg, transparent, transparent 5px, #cc3333 5px, #cc3333 7px);")}a.push(G`
					<div
						class="cell"
					...
					></div>
				`)}return a}_onCellMouseDown(t){this.dispatchEvent(new CustomEvent("cell-paint",{detail:{index:t,action:"down"},bubbles:!0,composed:!0}))}_onCellMouseEnter(t){this.dispatchEvent(new CustomEvent("cell-paint",{detail:{index:t,action:"enter"},bubbles:!0,composed:!0}))}_onCellMouseUp(){this.dispatchEvent(new CustomEvent("cell-paint",{detail:{action:"up"},bubbles:!0,composed:!0}))}_renderTargetDots(t,e,i,o){return G`
			<div class="targets-overlay" style="pointer-events: none;">
				${this.targets.map((s,r)=>{if("inactive"===s.status)return j;let n=null!=s.x?pe(s.x,s.y,this.roomWidth,this.roomDepth):null;const a=n&&n.col>=t&&n.col<=t+i&&n.row>=e&&n.row<=e+o;if("pending"===s.status&&!a&&this.targetPrevXY[r]&&(n=pe(this.targetPrevXY[r].x,this.targetPrevXY[r].y,this.roomWidth,this.roomDepth)),!n)return j;const l=Math.max(0,Math.min(100,(n.col-t)/i*100)),c=Math.max(0,Math.min(100,(n.row-e)/o*100));if(this.dismissedTargets.has(r)){const t=Math.floor(n.col),e=Math.floor(n.row)*Ot+t;if(this.dismissedTargets.get(r)===e)return j;this.dismissedTargets.delete(r),this.dispatchEvent(new CustomEvent("target-undismissed",{detail:{targetIndex:r},bubbles:!0,composed:!0}))}if(this.grid.length>0){const t=Math.floor(n.col),e=Math.floor(n.row)*Ot+t;if(e>=0&&e<this.grid.length){if(Xt(this.grid[e])>0){const t=Zt(this.grid[e]);if(!this.occupancy[t])return j}}}const h="pending"===s.status?.3:1;return G`
						<div
							class="target-dot ${this.editable?"":"clickable"}"
							style="left: ${l}%; top: ${c}%; background: ${oe[r]||oe[0]}; opacity: ${h}; transition: opacity 0.5s ease;"
							@click=${t=>{this.editable||(t.stopPropagation(),this.dispatchEvent(new CustomEvent("target-click",{detail:{targetIndex:r,x:s.x,y:s.y,pctX:l,pctY:c},bubbles:!0,composed:!0})))}}
						></div>
						${"active"===s.status&&s.signal>0?G`
		...
		`}_renderGridDimensions(){const t=ye(this.grid,this.roomWidth,this.perspective);return t?G`
			<div class="grid-dimensions">
				${t.widthM}m × ${t.depthM}m · Furthest point: ${t.furthestM}m
			</div>
		`:j}_renderFurnitureOverlay(t,e,i,o,s){return this.furniture.length?G`
  ...
  `,t([gt({attribute:!1})],we.prototype,"sensorState",void 0),t([gt({attribute:!1})],we.prototype,"zoneState",void 0),t([gt({attribute:!1})],we.prototype,"zoneConfigs",void 0),t([gt({attribute:!1})],we.prototype,"perspective",void 0),t([gt({attribute:!1})],we.prototype,"localize",void 0),t([ft()],we.prototype,"_expandedSensorInfo",void 0),customElements.get("epp-live-sidebar")||customElements.define("epp-live-sidebar",we);class $e extends ct{constructor(){super(...arguments),this.sensorState={occupancy:!1,static_presence:!1,motion_presence:!1,target_presence:!1,illuminance:null,temperature:null,humidity:null,co2:null},this.targetAutoDistance=!0,this.targetMaxDistance=6,this.staticAutoDistance=!0,this.staticMinDistance=.3,this.staticMaxDistance=16,this.openAccordions=new Set,this.perspective=null,this.roomWidth=0,this.roomDepth=0,this.grid=new Uint8Array(0),this.saving=!1,this.dirty=!1,this.temperatureOffset=0,this.humidityOffset=0,this.illuminanceOffset=0,this.motionTimeout=5,this.staticTimeout=30,this.staticTriggerThreshold=3,this.staticRenewThreshold=3,this.staticOnDelay=0,this.entitiesConfig={},this.logLevels={},this.bluetoothEnabled=!1,this.co2Enabled=!1,this.ledMode="Manual Control",this.ledBrightness=1,this.ledPresenceColor="#CC33FF",this.relayTriggerMode="disabled",this.relayContactMode="no",this.targetUpdateRateMs=1e3,this.zoneUpdateRateMs=1e3,this._overrides={},this.localize=t=>t}render(){return G`
    ...
    ><ha-icon icon="mdi:help-circle-outline"></ha-icon><span class="setting-info-tooltip">${t}</span></button>`}renderDetectionRanges(){const t=ve(this.roomWidth,this.roomDepth,this.perspective,this.grid),e=ye(this.grid,this.roomWidth,this.perspective),i=t>0?Math.min(t,6):6,o=t>0?Math.min(t,16):16,s=this.targetAutoDistance?i:this.targetMaxDistance,r=this.staticAutoDistance?o:this.staticMaxDistance,n="opacity: 0.5; pointer-events: none;";return G`
      <div class="settings-section">
        ...
        <div class="setting-group">
          ...
          <div class="setting-row">
            ...
            <label class="toggle-switch">
              <input type="checkbox" .checked=${this.targetAutoDistance}
                @change=${t=>{const e=t.target.checked;e||(this._overrides.targetMaxDistance=s,this._fireChange("targetMaxDistance",s)),this._overrides.targetAutoDistance=e,this._fireChange("targetAutoDistance",e)}} />
          ...
          <div class="setting-row" style="${this.targetAutoDistance?n:""}">
            ...
            <span class="setting-input-unit"><input type="range" class="setting-range" .value=${String(s)} min="0.5" max="6" step="0.1"
              @input=${t=>{const e=t.target,i=Number(e.value);this._overrides.targetMaxDistance=i,this._fireChange("targetMaxDistance",i),this._setText(e.nextElementSibling,i.toFixed(1))}} /><span class="setting-value">${s}</span><span class="setting-unit">m</span></span>
        ...
        <div class="setting-group">
          ...
          <div class="setting-row" style="${this.staticAutoDistance?n:""}">
            ...
            <span class="setting-input-unit"><input type="range" class="setting-range" .value=${String(this.staticAutoDistance?.3:this.staticMinDistance)} min="0.3" max="16" step="0.1"
              @input=${t=>{const e=t.target;let i=Number(e.value);const o=this._overrides.staticMaxDistance??this.staticMaxDistance;i>=o&&(i=Math.round(10*(o-.1))/10,e.value=String(i)),this._overrides.staticMinDistance=i,this._fireChange("staticMinDistance",i),this._setText(e.nextElementSibling,i.toFixed(1))}} /><span class="setting-value">${this.staticAutoDistance?.3:this.staticMinDistance}</span><span class="setting-unit">m</span></span>
          ...
          <div class="setting-row" style="${this.staticAutoDistance?n:""}">
            ...
            <span class="setting-input-unit"><input type="range" class="setting-range" .value=${String(r)} min="2.4" max="16" step="0.1"
              @input=${t=>{const e=t.target;let i=Number(e.value);const o=this._overrides.staticMinDistance??this.staticMinDistance;i<=o&&(i=Math.round(10*(o+.1))/10,e.value=String(i)),this._overrides.staticMaxDistance=i,this._fireChange("staticMaxDistance",i),this._setText(e.nextElementSibling,i.toFixed(1))}} /><span class="setting-value">${r}</span><span class="setting-unit">m</span></span>
            ${this.resetBtn(o,"staticMaxDistance")}${this.infoTip(this.localize("info.static_max_distance"))}
          </div>
        </div>
      </div>
      ...
      <div class="settings-section">
        ...
        <div class="setting-group">
          ...
          <div class="setting-row">
            ...
            <label class="toggle-switch"><input type="checkbox" @change=${o} data-entity-key="zone_presence" .checked=${i("zone_presence",!0)} .disabled=${!this.perspective} /><span class="toggle-slider"></span></label>
            ${this.infoTip(this.localize("info.zone_presence"))}
          </div>
          <div class="setting-row">
            <label>${this.localize("entities.zone_target_count")}</label>
            <label class="toggle-switch"><input type="checkbox" @change=${o} data-entity-key="zone_target_count" .checked=${i("zone_target_count",!1)} .disabled=${!this.perspective} /><span class="toggle-slider"></span></label>
            ${this.infoTip(this.localize("info.zone_target_count"))}
          </div>
          <div class="setting-row">
            <label>${this.localize("settings.update_rate")}</label>
            <ha-select
              .value=${String(s.zoneUpdateRateMs??this.zoneUpdateRateMs)}
              .options=${a}
              .disabled=${!r}
        ...
        <div class="setting-group">
          ...
          <div class="setting-row">
            ...
            <label class="toggle-switch"><input type="checkbox" @change=${o} data-entity-key="target_xy" .checked=${i("target_xy",!1)} .disabled=${!this.perspective} /><span class="toggle-slider"></span></label>
            ${this.infoTip(this.localize("info.xy"))}
          </div>
          <div class="setting-row">
            <label>${this.localize("entities.active")}</label>
            <label class="toggle-switch"><input type="checkbox" @change=${o} data-entity-key="target_active" .checked=${i("target_active",!1)} /><span class="toggle-slider"></span></label>
            ${this.infoTip(this.localize("info.active"))}
          </div>
          <div class="setting-row">
            <label>${this.localize("entities.target_signal")}</label>
            <label class="toggle-switch"><input type="checkbox" @change=${o} data-entity-key="target_signal" .checked=${i("target_signal",!1)} /><span class="toggle-slider"></span></label>
            ${this.infoTip(this.localize("info.target_signal"))}
          </div>
          <div class="setting-row">
            <label>${this.localize("entities.target_zone")}</label>
            <label class="toggle-switch"><input type="checkbox" @change=${o} data-entity-key="target_zone" .checked=${i("target_zone",!1)} /><span class="toggle-slider"></span></label>
            ${this.infoTip(this.localize("info.target_zone"))}
          </div>
          <div class="setting-row">
            <label>${this.localize("settings.update_rate")}</label>
            <ha-select
              .value=${String(s.targetUpdateRateMs??this.targetUpdateRateMs)}
              .options=${a}
              .disabled=${!n}
          ...
          ${e.filter(t=>t.show).map(e=>{const i=(this._overrides.logLevels||{})[e.key]??this.logLevels[e.key]??"None";return G`
              <div class="setting-row">
                ...
                <ha-select
                  ...
                  @selected=${t=>{const o=t.detail.value;o&&o!==i&&(this._overrides.logLevels||(this._overrides.logLevels={}),this._overrides.logLevels[e.key]=o,this._fireDirty(),this.requestUpdate())}}
                  @closed=${t=>t.stopPropagation()}
                ></ha-select>
    ...
    `}_emitSave(){const t=this._overrides,e={...this.entitiesConfig,...t.entities||{}},i=t.targetAutoDistance??this.targetAutoDistance,o=t.staticAutoDistance??this.staticAutoDistance;let s=t.targetMaxDistance??this.targetMaxDistance,r=t.staticMinDistance??this.staticMinDistance,n=t.staticMaxDistance??this.staticMaxDistance;if(i||o){const t=ve(this.roomWidth,this.roomDepth,this.perspective,this.grid);i&&(s=t>0?Math.min(t,6):6),o&&(r=.3,n=t>0?Math.min(t,16):16)}this.dispatchEvent(new CustomEvent("save",{detail:{target_auto_distance:i,target_max_distance:s,static_auto_distance:o,static_min_distance:r,static_max_distance:n,motion_timeout:t.motionTimeout??this.motionTimeout,static_timeout:t.staticTimeout??this.staticTimeout,static_trigger_threshold:t.staticTriggerThreshold??this.staticTriggerThreshold,static_renew_threshold:t.staticRenewThreshold??this.staticRenewThreshold,static_on_delay:t.staticOnDelay??this.staticOnDelay,temperature_offset:t.temperatureOffset??this.temperatureOffset,humidity_offset:t.humidityOffset??this.humidityOffset,illuminance_offset:t.illuminanceOffset??this.illuminanceOffset,entities:e,log_levels:{...this.logLevels,...t.logLevels||{}},led_mode:t.ledMode??this.ledMode,led_brightness:t.ledBrightness??this.ledBrightness,led_presence_color:t.ledPresenceColor??this.ledPresenceColor,relay_trigger_mode:t.relayTriggerMode??this.relayTriggerMode,relay_contact_mode:t.relayContactMode??this.relayContactMode,target_update_rate_ms:t.targetUpdateRateMs??this.targetUpdateRateMs,zone_update_rate_ms:t.zoneUpdateRateMs??this.zoneUpdateRateMs},bubbles:!0,composed:!0}))}_fireChange(t,e){this.dispatchEvent(new CustomEvent("setting-change",{detail:{key:t,value:e},bubbles:!0,composed:!0})),this._fireDirty()}_fireDirty(){const t=this.shadowRoot?.querySelector(".save-btn");t&&(t.disabled=!1),this.dispatchEvent(new CustomEvent("dirty",{bubbles:!0,composed:!0}))}}$e.styles=[yt,bt,xt,wt,zt,n`
      :host {
        display: block;
      }
    ...
    `,e=(t,e,i,o)=>{const s=i-t,r=o-e,n=Math.sqrt(s*s+r*r),a=s/n,l=r/n,c=i-40*a,h=o-40*l;return Z`
      ...
      `},i=50,o=55,s=290,r=55,n=290,a=225,l=50,c=235,h=98,d=225,p=Z`
    ...
    `}_renderWizardCorners(){const t=this._wizardCornerIndex,e=this.rawTargets.filter(t=>null!=t.raw_x&&null!=t.raw_y),i=e.length>0,o=e.length>1,s=this._wizardCorners.every(t=>null!==t),r=ee[t]||"",[n,a]=ie[t]||["",""];return G`
      <div class="wizard-card">
        ...
        <div class="corner-progress">
          ${ee.map((e,i)=>{const o=!!this._wizardCorners[i],s=i<3,r=i<t;return G`
                <span
    ...
    `}_renderMiniSensorView(){const t=ne,e=Wt,i=200,o=-t,s=e*Math.cos(re),r=`M 0 0 L ${o} ${s} A 6000 6000 0 0 0 ${t} ${s} Z`,n=[2e3,4e3].map(t=>{const e=t*Math.sin(re),i=t*Math.cos(re);return`M ${-e} ${i} A ${t} ${t} 0 0 0 ${e} ${i}`});return G`
    ...
    `}_renderUncalibratedFov(){const t=this.sensorState.occupancy,e=t?"#4CAF50":"var(--primary-color, #03a9f4)",i=160,o=14,s=180,r=30*Math.PI/180,n=150*Math.PI/180,a=i+s*Math.cos(r),l=o+s*Math.sin(r),c=i+s*Math.cos(n),h=o+s*Math.sin(n);return G`
      <div style="display: flex; flex-direction: column; align-items: center; padding: 24px;">
        <svg viewBox="0 0 320 210" width="320" height="210" style="display: block;">
          ...
          <!-- Target dots -->
          ${this.rawTargets.map((t,e)=>{if(null==t.raw_x||null==t.raw_y)return j;const r=Math.sqrt(t.raw_x*t.raw_x+t.raw_y*t.raw_y),n=Math.atan2(t.raw_x,t.raw_y),a=Math.min(r/6e3,1)*s,l=Math.PI/2-n,c=i+a*Math.cos(l),h=o+a*Math.sin(l);return Z`<circle cx="${c}" cy="${h}" r="5" fill="${oe[e]||oe[0]}"/>`})}
    ...
    `,e=(()=>{const t=28,e=28,i=180,o=-15*Math.PI/180,s=105*Math.PI/180,r=t+i*Math.cos(o),n=e+i*Math.sin(o),a=t+i*Math.cos(s),l=e+i*Math.sin(s),c=(i,r)=>{const n=t+i*Math.cos(o),a=e+i*Math.sin(o),l=t+i*Math.cos(s),c=e+i*Math.sin(s),h=45*Math.PI/180,d=t+(i-10)*Math.cos(h),p=e+(i-10)*Math.sin(h);return Z`
    ...
    `}_fireStartCalibration(){this.dispatchEvent(new CustomEvent("start-calibration",{bubbles:!0,composed:!0}))}_fireCancel(){this._setupStep=null,this._wizardCorners=[null,null,null,null],this._wizardCornerIndex=0,this._wizardOffsetSide="",this._wizardOffsetFb="",this.dispatchEvent(new CustomEvent("wizard-cancel",{bubbles:!0,composed:!0}))}}ke.styles=[bt,kt,xt,n`
      :host {
        display: block;
      }
    ...
    `],t([gt({attribute:!1})],ke.prototype,"hass",void 0),t([gt({type:String})],ke.prototype,"selectedMac",void 0),t([gt({attribute:!1})],ke.prototype,"rawTargets",void 0),t([gt({attribute:!1})],ke.prototype,"sensorState",void 0),t([gt({attribute:!1})],ke.prototype,"devices",void 0),t([gt({attribute:!1})],ke.prototype,"localize",void 0),t([gt({type:Number})],ke.prototype,"initialRoomWidth",void 0),t([gt({type:Number})],ke.prototype,"initialRoomDepth",void 0),t([gt({type:String})],ke.prototype,"mode",void 0),t([ft()],ke.prototype,"_setupStep",void 0),t([ft()],ke.prototype,"_wizardSaving",void 0),t([ft()],ke.prototype,"_wizardCornerIndex",void 0),t([ft()],ke.prototype,"_wizardCorners",void 0),t([ft()],ke.prototype,"_wizardRoomWidth",void 0),t([ft()],ke.prototype,"_wizardRoomDepth",void 0),t([ft()],ke.prototype,"_wizardCapturing",void 0),t([ft()],ke.prototype,"_wizardCaptureProgress",void 0),t([ft()],ke.prototype,"_wizardCapturePaused",void 0),t([ft()],ke.prototype,"_wizardOffsetSide",void 0),t([ft()],ke.prototype,"_wizardOffsetFb",void 0),customElements.get("epp-wizard")||customElements.define("epp-wizard",ke);class ze extends ct{constructor(){super(...arguments),this.overlayMode=null,this.localize=t=>t}render(){return G`
	...
	`,t([gt({attribute:!1})],ze.prototype,"overlayMode",void 0),t([gt({attribute:!1})],ze.prototype,"localize",void 0),customElements.get("epp-overlay-sidebar")||customElements.define("epp-overlay-sidebar",ze);const Ce={normal:{trigger:5,renew:3,timeout:10,handoff_timeout:3},thoroughfare:{trigger:3,renew:2,timeout:3,handoff_timeout:1},rest:{trigger:7,renew:1,timeout:30,handoff_timeout:10}},Te=["#E69F00","#56B4E9","#009E73","#F0E442","#0072B2","#D55E00","#CC79A7"];function Ee(t,e,i,o,s,r,n){if(0===t){const t=Ce[i]||Ce.normal;return"custom"===i?{trigger:o,renew:s,timeout:r,handoffTimeout:n}:{trigger:t.trigger,renew:t.renew,timeout:t.timeout,handoffTimeout:t.handoff_timeout}}if(t>0&&t<=e.length){const i=e[t-1];if(i){const t=Ce[i.type]||Ce.normal;return"custom"===i.type?{trigger:i.trigger??t.trigger,renew:i.renew??t.renew,timeout:i.timeout??t.timeout,handoffTimeout:i.handoff_timeout??t.handoff_timeout}:{trigger:t.trigger,renew:t.renew,timeout:t.timeout,handoffTimeout:t.handoff_timeout}}}return{trigger:5,renew:3,timeout:10,handoffTimeout:3}}class Me extends ct{constructor(){super(...arguments),this.zoneConfigs=[],this.activeZone=null,this.roomType="normal",this.roomTrigger=Ce.normal.trigger,this.roomRenew=Ce.normal.renew,this.roomTimeout=Ce.normal.timeout,this.roomHandoffTimeout=Ce.normal.handoff_timeout,this.localZoneState=new Map,this.localize=t=>t}render(){return this._renderZoneSidebar()}_renderZoneSidebar(){return G`
			...
			>
				...
				>
					...
					<select
						...
						.value=${this.roomType}
						@change=${t=>{const e=t.target.value,i=Ce[e]||Ce.normal;this.dispatchEvent(new CustomEvent("room-config-change",{detail:{updates:{roomType:e,roomTrigger:i.trigger,roomRenew:i.renew,roomTimeout:i.timeout,roomHandoffTimeout:i.handoff_timeout}},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("dirty",{bubbles:!0,composed:!0}))}}
						@click=${t=>t.stopPropagation()}
					>
						<option value="normal">
		...
		`}_renderZoneTypeControls(t,e){const i="custom"===t.type,o=Ce[t.type]||Ce.normal,s=t.trigger??o.trigger,r=t.renew??o.renew,n=t.timeout??o.timeout,a=t.handoff_timeout??o.handoff_timeout,l=`width: 100%; display: flex; align-items: center; gap: 4px; font-size: 12px; opacity: ${i?1:.5};`;return G`
			<div
				class="zone-item-row zone-settings-row"
				style="flex-wrap: wrap; gap: 3px; padding: 4px 8px;"
			>
				...
				>
					...
					<select
						...
						style="flex: 1; min-width: 0;"
						.value=${t.type}
						@change=${t=>{const i=t.target.value,o=Ce[i]||Ce.normal;this.dispatchEvent(new CustomEvent("zone-config-change",{detail:{index:e,updates:{type:i,trigger:o.trigger,renew:o.renew,timeout:o.timeout,handoff_timeout:o.handoff_timeout}},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("dirty",{bubbles:!0,composed:!0}))}}
						@click=${t=>t.stopPropagation()}
					>
						<option value="normal">
							${this.localize("zones.normal")}
    ...
    `}_renderTabBar(){return G`
			<div class="tab-bar">
				...
				<button class="tab ${"flasher"===this._panelTab?"active":""}"
					@click=${()=>{this._panelTab="flasher",this._flasherCtrl.loading&&(this._flasherCtrl.hass=this.hass,this._flasherCtrl.loadDevices())}}>Flash Firmware</button>
			</div>
        ...
        <epp-wizard
          ...
          @calibration-complete=${async t=>{const{perspective:e,roomWidth:i,roomDepth:o}=t.detail;this._perspective=e,this._roomWidth=i,this._roomDepth=o,this._initGridFromRoom(),this._setupStep=null,this._view="live",this._entitiesConfig={...this._entitiesConfig,zone_presence:!0},await this._gridCtrl.applyLayout().catch(t=>{console.error("Failed to apply layout after calibration",t)})}}
    ...
    `}_renderProtocolBanner(){const t=this._devices.find(t=>t.mac===this._selectedMac);if(!t||"compatible"===t.config_protocol_status)return j;const e=t.config_protocol_status,i="firmware_behind"===e,o="unavailable"===e?this._localize("protocol.unavailable"):i?this._localize("protocol.firmware_behind"):this._localize("protocol.firmware_ahead");return G`
		...
		`}_retryConnection(){this._selectedMac&&this._loadDeviceConfig(this._selectedMac)}_renderLiveGrid(){for(let t=0;t<this._targets.length;t++){const e=this._targets[t];null!=e.x&&null!=e.y&&"active"===e.status&&(this._zoneEngineState.targetPrevXY[t]={x:e.x,y:e.y})}const t={};for(const[e,i]of Object.entries(this._zoneState.occupancy))t[Number(e)]=i;return G`
			...
			></epp-grid>
		`}_showTargetMenu(t){this._targetMenu=t}_closeTargetMenu(){this._targetMenu=null}_targetCellIndex(t,e){const i=pe(t,e,this._roomWidth,this._roomDepth);if(!i)return-1;const o=Math.floor(i.col),s=Math.floor(i.row);return o<0||o>=Ot||s<0||s>=Nt?-1:s*Ot+o}async _dismissTarget(){if(!this._targetMenu)return;const{targetIndex:t,x:e,y:i}=this._targetMenu,o=this._targetCellIndex(e,i);if(o>=0){this._dismissedTargets=new Map(this._dismissedTargets),this._dismissedTargets.set(t,o);try{await this.hass.callWS({type:"eppgrid/dismiss_target",mac:this._selectedMac,target_index:t,cell_index:o})}catch(t){console.error("Failed to dismiss target:",t)}}this._closeTargetMenu(),this.requestUpdate()}async _setInterference(t){if(!this._targetMenu)return;const e=this._targetCellIndex(this._targetMenu.x,this._targetMenu.y);e<0||!Gt(this._grid[e])?this._closeTargetMenu():(this._grid=new Uint8Array(this._grid),this._grid[e]=Yt(this._grid[e],t),this._dirty=!0,this._closeTargetMenu(),await this._gridCtrl.applyLayout())}_renderTargetMenu(){if(!this._targetMenu)return j;const{pctX:t,pctY:e}=this._targetMenu;return G`
			...
			<div class="target-menu" style="left: ${t}%; top: ${e}%;">
				...
				<button class="target-menu-item" @click=${()=>this._setInterference(7)}>
    ...
    `}_toggleAccordion(t){this._openAccordions=this._openAccordions.has(t)?new Set:new Set([t])}_getSensorRoomPosition(){return _e(this._perspective)}_autoDetectionRange(){return ve(this._roomWidth,this._roomDepth,this._perspective,this._grid)}_renderSettings(){return G`
      <div class="panel">
        ${this._renderHeader()}
        <epp-settings-view
          .sensorState=${this._sensorState}
    ...
    `}_renderFurnitureOverlay(t,e,i,o,s){return this._furniture.length?G`
			<epp-furniture-overlay
				.furniture=${this._furniture}
				.selectedFurnitureId=${this._selectedFurnitureId}
				.roomWidth=${this._roomWidth}
				...
				@furniture-delete=${t=>{this._removeFurniture(t.detail)}}
			></epp-furniture-overlay>
		`:j}}Ki.styles=[mt,_t,vt,bt,kt,$t,Ct,Et,n`
    .cell {
      cursor: pointer;
      transition: opacity 0.1s;
    }
  ...
  `],t([gt({attribute:!1})],Ki.prototype,"hass",void 0),t([ft()],Ki.prototype,"_grid",void 0),t([ft()],Ki.prototype,"_zoneConfigs",void 0),t([ft()],Ki.prototype,"_activeZone",void 0),t([ft()],Ki.prototype,"_roomType",void 0),t([ft()],Ki.prototype,"_roomTrigger",void 0),t([ft()],Ki.prototype,"_roomRenew",void 0),t([ft()],Ki.prototype,"_roomTimeout",void 0),t([ft()],Ki.prototype,"_roomHandoffTimeout",void 0),t([ft()],Ki.prototype,"_targetAutoDistance",void 0),t([ft()],Ki.prototype,"_targetMaxDistance",void 0),t([ft()],Ki.prototype,"_staticAutoDistance",void 0),t([ft()],Ki.prototype,"_staticMinDistance",void 0),t([ft()],Ki.prototype,"_staticMaxDistance",void 0),t([ft()],Ki.prototype,"_temperatureOffset",void 0),t([ft()],Ki.prototype,"_humidityOffset",void 0),t([ft()],Ki.prototype,"_illuminanceOffset",void 0),t([ft()],Ki.prototype,"_motionTimeout",void 0),t([ft()],Ki.prototype,"_staticTimeout",void 0),t([ft()],Ki.prototype,"_staticTriggerThreshold",void 0),t([ft()],Ki.prototype,"_staticRenewThreshold",void 0),t([ft()],Ki.prototype,"_staticOnDelay",void 0),t([ft()],Ki.prototype,"_logLevels",void 0),t([ft()],Ki.prototype,"_bluetoothEnabled",void 0),t([ft()],Ki.prototype,"_co2Enabled",void 0),t([ft()],Ki.prototype,"_ledMode",void 0),t([ft()],Ki.prototype,"_ledBrightness",void 0),t([ft()],Ki.prototype,"_ledPresenceColor",void 0),t([ft()],Ki.prototype,"_relayTriggerMode",void 0),t([ft()],Ki.prototype,"_relayContactMode",void 0),t([ft()],Ki.prototype,"_targetUpdateRateMs",void 0),t([ft()],Ki.prototype,"_zoneUpdateRateMs",void 0),t([ft()],Ki.prototype,"_entitiesConfig",void 0),t([ft()],Ki.prototype,"_sidebarTab",void 0),t([ft()],Ki.prototype,"_panelTab",void 0),t([ft()],Ki.prototype,"_showDeleteCalibrationDialog",void 0),t([ft()],Ki.prototype,"_showLiveMenu",void 0),t([ft()],Ki.prototype,"_showCustomIconPicker",void 0),t([ft()],Ki.prototype,"_customIconValue",void 0),t([ft()],Ki.prototype,"_furniture",void 0),t([ft()],Ki.prototype,"_selectedFurnitureId",void 0),t([ft()],Ki.prototype,"_targets",void 0),t([ft()],Ki.prototype,"_rawTargets",void 0),t([ft()],Ki.prototype,"_sensorState",void 0),t([ft()],Ki.prototype,"_zoneState",void 0),t([ft()],Ki.prototype,"_showHitCounts",void 0),t([ft()],Ki.prototype,"_showDebugLog",void 0),t([ft()],Ki.prototype,"_showBackendDebugLog",void 0),t([ft()],Ki.prototype,"_overlayMode",void 0),t([ft()],Ki.prototype,"_targetMenu",void 0),t([ft()],Ki.prototype,"_isPainting",void 0),t([ft()],Ki.prototype,"_paintAction",void 0),t([ft()],Ki.prototype,"_saving",void 0),t([ft()],Ki.prototype,"_dirty",void 0),t([ft()],Ki.prototype,"_showUnsavedDialog",void 0),t([ft()],Ki.prototype,"_showTemplateSave",void 0),t([ft()],Ki.prototype,"_showTemplateLoad",void 0),t([ft()],Ki.prototype,"_templateName",void 0),t([ft()],Ki.prototype,"_devices",void 0),t([ft()],Ki.prototype,"_selectedMac",void 0),t([ft()],Ki.prototype,"_loading",void 0),t([ft()],Ki.prototype,"_setupStep",void 0),t([ft()],Ki.prototype,"_view",void 0),t([ft()],Ki.prototype,"_openAccordions",void 0),t([ft()],Ki.prototype,"_perspective",void 0),t([ft()],Ki.prototype,"_roomWidth",void 0),t([ft()],Ki.prototype,"_roomDepth",void 0),customElements.get("eppgrid-panel")||customElements.define("eppgrid-panel",Ki);let Ji=class extends ct{setConfig(t){}render(){return G`<eppgrid-panel .hass=${this.hass}></eppgrid-panel>`}};Ji.styles=n`:host { display: block; height: 100%; }`,t([gt({attribute:!1})],Ji.prototype,"hass",void 0),Ji=t([dt("epp-device-card")],Ji);let Qi=class extends ct{constructor(){super(...arguments),this._flasherCtrl=new De(this)}setConfig(t){}updated(t){t.has("hass")&&this.hass&&(this._flasherCtrl.hass=this.hass,this._flasherCtrl.loading&&this._flasherCtrl.loadDevices())}render(){return G`
            <epp-flasher-view
                .hass=${this.hass}
                .flashableDevices=${this._flasherCtrl.flashableDevices}
                .loading=${this._flasherCtrl.loading}
                ...
                @flash-ota=${t=>{this._flasherCtrl.startOtaFlash(t.detail.mac,t.detail.variant)}}
            ></epp-flasher-view>
        `}};Qi.styles=n`:host { display: block; }`,t([gt({attribute:!1})],Qi.prototype,"hass",void 0),Qi=t([dt("epp-flasher-card")],Qi);class to{static async generate(){return{views:[{title:"Device Configuration",cards:[{type:"custom:epp-device-card"}]},{title:"Flash Firmware",cards:[{type:"custom:epp-flasher-card"}]}]}}}window.customCards=window.customCards||[],window.customCards.push({type:"epp-device-card",name:"EPP Grid Device Configuration",description:"EPP Grid device calibration and zone editor"},{type:"epp-flasher-card",name:"EPP Grid Firmware Flasher",description:"Flash EPP Grid firmware to devices"}),window.customStrategies=window.customStrategies||{},window.customStrategies.eppgrid={generateDashboard:()=>to.generate()};export{Ki as EPPGridPanel,to as EPPGridStrategy,Ji as EppDeviceCard,Qi as EppFlasherCard};
