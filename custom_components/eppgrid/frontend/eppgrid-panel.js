...
`,kt={normal:{trigger:5,renew:3,timeout:10,handoff_timeout:3},entrance:{trigger:3,renew:2,timeout:5,handoff_timeout:1},thoroughfare:{trigger:3,renew:2,timeout:3,handoff_timeout:1},rest:{trigger:7,renew:1,timeout:30,handoff_timeout:10}},Et=["#E69F00","#56B4E9","#009E73","#F0E442","#0072B2","#D55E00","#CC79A7"];function Ct(t,e,i,o,r,s,n,a){if(0===t){const t=kt[i]||kt.normal;return"custom"===i?{trigger:o,renew:r,timeout:s,handoffTimeout:n,entryPoint:a}:{trigger:t.trigger,renew:t.renew,timeout:t.timeout,handoffTimeout:t.handoff_timeout,entryPoint:!1}}if(t>0&&t<=e.length){const i=e[t-1];if(i){const t=kt[i.type]||kt.normal;return"custom"===i.type?{trigger:i.trigger??t.trigger,renew:i.renew??t.renew,timeout:i.timeout??t.timeout,handoffTimeout:i.handoff_timeout??t.handoff_timeout,entryPoint:i.entry_point??!1}:{trigger:t.trigger,renew:t.renew,timeout:t.timeout,handoffTimeout:t.handoff_timeout,entryPoint:"entrance"===i.type}}}return{trigger:5,renew:3,timeout:10,handoffTimeout:3,entryPoint:!1}}class Tt extends ct{constructor(){super(...arguments),this.zoneConfigs=[],this.activeZone=null,this.roomType="normal",this.roomTrigger=kt.normal.trigger,this.roomRenew=kt.normal.renew,this.roomTimeout=kt.normal.timeout,this.roomHandoffTimeout=kt.normal.handoff_timeout,this.roomEntryPoint=!1,this.localZoneState=new Map,this.localize=t=>t}render(){return this._renderZoneSidebar()}_renderZoneSidebar(){return W`
			...
			>
				...
				>
					...
					<select
						...
						.value=${this.roomType}
						@change=${t=>{const e=t.target.value,i=kt[e]||kt.normal;this.dispatchEvent(new CustomEvent("room-config-change",{detail:{updates:{roomType:e,roomTrigger:i.trigger,roomRenew:i.renew,roomTimeout:i.timeout,roomHandoffTimeout:i.handoff_timeout}},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("dirty",{bubbles:!0,composed:!0}))}}
						@click=${t=>t.stopPropagation()}
					>
						<option value="normal">
		...
		`}_renderZoneTypeControls(t,e){const i="custom"===t.type,o=kt[t.type]||kt.normal,r=t.trigger??o.trigger,s=t.renew??o.renew,n=t.timeout??o.timeout,a=t.handoff_timeout??o.handoff_timeout,l=`width: 100%; display: flex; align-items: center; gap: 4px; font-size: 12px; opacity: ${i?1:.5};`;return W`
			<div
				class="zone-item-row zone-settings-row"
				style="flex-wrap: wrap; gap: 3px; padding: 4px 8px;"
			>
				...
				>
					...
					<select
						...
						style="flex: 1; min-width: 0;"
						.value=${t.type}
						@change=${t=>{const i=t.target.value,o=kt[i]||kt.normal;this.dispatchEvent(new CustomEvent("zone-config-change",{detail:{index:e,updates:{type:i,trigger:o.trigger,renew:o.renew,timeout:o.timeout,handoff_timeout:o.handoff_timeout}},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("dirty",{bubbles:!0,composed:!0}))}}
						@click=${t=>t.stopPropagation()}
					>
						<option value="normal">
							${this.localize("zones.normal")}
 ...
 */class Ht extends Pt{}Ht.directiveName="unsafeSVG",Ht.resultType=2;const Rt=At(Ht),Bt=20,Lt=20,It=400,Nt=300,Ft=6e3,Ut=t=>!!(1&t),Ot=t=>t>>1&7,Gt=(t,e)=>-15&t|(7&e)<<1;function Wt(t){let e=Bt,i=0,o=Lt,r=0;for(let s=0;s<It;s++)if(Ut(t[s])){const t=s%Bt,n=Math.floor(s/Bt);t<e&&(e=t),t>i&&(i=t),n<o&&(o=n),n>r&&(r=n)}return{minCol:Math.max(0,e-1),maxCol:Math.min(19,i+1),minRow:Math.max(0,o-1),maxRow:Math.min(19,r+1)}}function Zt(t){let e=Bt,i=0,o=Lt,r=0;for(let s=0;s<It;s++)if(Ut(t[s])){const t=s%Bt,n=Math.floor(s/Bt);t<e&&(e=t),t>i&&(i=t),n<o&&(o=n),n>r&&(r=n)}return{minCol:e,maxCol:i,minRow:o,maxRow:r}}function Vt(t,e){const i=new Uint8Array(It),o=Math.ceil(t/Nt),r=Math.ceil(e/Nt),s=Math.floor((Bt-o)/2);for(let t=0;t<Lt;t++)for(let e=0;e<Bt;e++){e>=s&&e<s+o&&t>=0&&t<0+r&&(i[t*Bt+e]=1)}return i}const jt={armchair:{viewBox:"0 0 256 256",content:'<rect x="16" y="16" width="224" height="224" rx="16" stroke="black" stroke-width="12" fill="none"/><rect x="16" y="16" width="224" height="48" rx="8" stroke="black" stroke-width="12" fill="none"/><rect x="16" y="64" width="48" height="176" rx="8" stroke="black" stroke-width="12" fill="none"/><rect x="192" y="64" width="48" height="176" rx="8" stroke="black" stroke-width="12" fill="none"/><rect x="64" y="64" width="128" height="176" rx="8" stroke="black" stroke-width="8" fill="none"/>'},bath:{viewBox:"0 0 600 300",content:'<rect x="50" y="50" width="500" height="200" rx="40" stroke="black" stroke-width="8" fill="none"/><path d="M 100 220 C 100 240, 500 240, 500 220" stroke="black" stroke-width="8" fill="none"/><rect x="70" y="70" width="30" height="20" stroke="black" stroke-width="8" fill="none"/><rect x="80" y="90" width="10" height="20" stroke="black" stroke-width="8" fill="none"/><circle cx="510" cy="150" r="10" stroke="black" stroke-width="8" fill="none"/>'},"bed-double":{viewBox:"0 0 512 512",content:'<rect x="0" y="0" width="512" height="512" rx="16" stroke="black" stroke-width="16" fill="none"/><path d="M0 64C0 46.3269 16.3269 32 32 32H480C497.673 32 512 46.3269 512 64V128C512 145.673 497.673 160 480 160H32C16.3269 160 0 145.673 0 128V64Z" stroke="black" stroke-width="16" fill="none"/><rect x="32" y="32" width="208" height="96" rx="8" stroke="black" stroke-width="16" fill="none"/><rect x="272" y="32" width="208" height="96" rx="8" stroke="black" stroke-width="16" fill="none"/><rect x="16" y="144" width="480" height="336" rx="8" stroke="black" stroke-width="16" fill="none"/><line x1="16" y1="256" x2="496" y2="256" stroke="#D0D0D0" stroke-width="8"/><line x1="16" y1="368" x2="496" y2="368" stroke="#D0D0D0" stroke-width="8"/>'},"bed-single":{viewBox:"0 0 256 512",content:'<rect x="0" y="0" width="256" height="512" rx="16" stroke="black" stroke-width="16" fill="none"/><path d="M0 64C0 46.3269 16.3269 32 32 32H224C241.673 32 256 46.3269 256 64V128C256 145.673 241.673 160 224 160H32C16.3269 160 0 145.673 0 128V64Z" stroke="black" stroke-width="16" fill="none"/><rect x="32" y="32" width="192" height="96" rx="8" stroke="black" stroke-width="16" fill="none"/><rect x="16" y="144" width="224" height="336" rx="8" stroke="black" stroke-width="16" fill="none"/><line x1="16" y1="256" x2="240" y2="256" stroke="#D0D0D0" stroke-width="8"/><line x1="16" y1="368" x2="240" y2="368" stroke="#D0D0D0" stroke-width="8"/>'},"door-left":{viewBox:"0 0 256 256",content:'<rect x="0" y="210" width="80" height="20" fill="black"/><rect x="60" y="60" width="20" height="150" fill="black"/><rect x="200" y="210" width="56" height="20" fill="black"/><path d="M 80 60 A 150 150 0 0 1 200 210" stroke="black" stroke-width="3" fill="none"/>'},"door-right":{viewBox:"0 0 256 256",content:'<rect x="176" y="210" width="80" height="20" fill="black"/><rect x="176" y="60" width="20" height="150" fill="black"/><rect x="0" y="210" width="56" height="20" fill="black"/><path d="M 176 60 A 150 150 0 0 0 56 210" stroke="black" stroke-width="3" fill="none"/>'},"floor-lamp":{viewBox:"0 0 256 256",content:'<circle cx="128" cy="128" r="96" stroke="black" stroke-width="16" fill="none"/><circle cx="128" cy="128" r="80" stroke="black" stroke-width="8" fill="none"/><circle cx="128" cy="128" r="16" fill="black"/><line x1="128" y1="112" x2="128" y2="48" stroke="black" stroke-width="8"/><circle cx="128" cy="48" r="8" fill="black"/><path d="M 64 64 A 128 128 0 0 1 192 64" stroke="black" stroke-width="8" stroke-dasharray="8 8"/>'},oven:{viewBox:"0 0 256 256",content:'<rect x="0" y="0" width="256" height="256" rx="16" stroke="black" stroke-width="16" fill="none"/><line x1="0" y1="224" x2="256" y2="224" stroke="black" stroke-width="16"/><circle cx="64" cy="64" r="40" stroke="black" stroke-width="16" fill="none"/><circle cx="64" cy="64" r="16" fill="black"/><circle cx="192" cy="64" r="40" stroke="black" stroke-width="16" fill="none"/><circle cx="192" cy="64" r="16" fill="black"/><circle cx="64" cy="192" r="40" stroke="black" stroke-width="16" fill="none"/><circle cx="64" cy="192" r="16" fill="black"/><circle cx="192" cy="192" r="40" stroke="black" stroke-width="16" fill="none"/><circle cx="192" cy="192" r="16" fill="black"/><rect x="32" y="240" width="192" height="16" rx="4" stroke="black" stroke-width="8" fill="black"/>'},plant:{viewBox:"0 0 256 256",content:'<circle cx="128" cy="128" r="96" stroke="black" stroke-width="16" fill="none"/><circle cx="128" cy="128" r="80" fill="none"/><g transform="translate(128 128)"><path d="M 0 0 C 0 -64, 40 -80, 0 -96 C -40 -80, 0 -64, 0 0 Z" fill="none" stroke="black" stroke-width="12"/><path d="M 0 0 C 0 -64, 40 -80, 0 -96 C -40 -80, 0 -64, 0 0 Z" transform="rotate(72)" fill="none" stroke="black" stroke-width="12"/><path d="M 0 0 C 0 -64, 40 -80, 0 -96 C -40 -80, 0 -64, 0 0 Z" transform="rotate(144)" fill="none" stroke="black" stroke-width="12"/><path d="M 0 0 C 0 -64, 40 -80, 0 -96 C -40 -80, 0 -64, 0 0 Z" transform="rotate(216)" fill="none" stroke="black" stroke-width="12"/><path d="M 0 0 C 0 -64, 40 -80, 0 -96 C -40 -80, 0 -64, 0 0 Z" transform="rotate(288)" fill="none" stroke="black" stroke-width="12"/></g>'},shower:{viewBox:"0 0 256 256",content:'<path d="M 32 32 H 224 V 224 H 32 Z" stroke="black" stroke-width="16" fill="none"/><line x1="32" y1="32" x2="224" y2="224" stroke="black" stroke-width="8" stroke-dasharray="8 8"/><line x1="224" y1="32" x2="32" y2="224" stroke="black" stroke-width="8" stroke-dasharray="8 8"/><circle cx="128" cy="200" r="16" stroke="black" stroke-width="16" fill="none"/>'},"sofa-two-seater":{viewBox:"0 0 400 200",content:'<rect x="8" y="8" width="384" height="184" rx="12" stroke="black" stroke-width="10" fill="none"/><rect x="8" y="8" width="384" height="48" rx="8" stroke="black" stroke-width="10" fill="none"/><rect x="24" y="56" width="172" height="128" rx="8" stroke="black" stroke-width="8" fill="none"/><rect x="204" y="56" width="172" height="128" rx="8" stroke="black" stroke-width="8" fill="none"/>'},"sofa-three-seater":{viewBox:"0 0 560 200",content:'<rect x="8" y="8" width="544" height="184" rx="12" stroke="black" stroke-width="10" fill="none"/><rect x="8" y="8" width="544" height="48" rx="8" stroke="black" stroke-width="10" fill="none"/><rect x="24" y="56" width="160" height="128" rx="8" stroke="black" stroke-width="8" fill="none"/><rect x="200" y="56" width="160" height="128" rx="8" stroke="black" stroke-width="8" fill="none"/><rect x="376" y="56" width="160" height="128" rx="8" stroke="black" stroke-width="8" fill="none"/>'},"table-dining-room":{viewBox:"0 0 600 400",content:'<rect x="150" y="100" width="300" height="200" stroke="black" stroke-width="8" fill="none" rx="10"/><rect x="80" y="150" width="60" height="100" stroke="black" stroke-width="8" fill="none" rx="5"/><rect x="460" y="150" width="60" height="100" stroke="black" stroke-width="8" fill="none" rx="5"/><rect x="175" y="30" width="100" height="60" stroke="black" stroke-width="8" fill="none" rx="5"/><rect x="325" y="30" width="100" height="60" stroke="black" stroke-width="8" fill="none" rx="5"/><rect x="175" y="310" width="100" height="60" stroke="black" stroke-width="8" fill="none" rx="5"/><rect x="325" y="310" width="100" height="60" stroke="black" stroke-width="8" fill="none" rx="5"/>'},"table-dining-room-round":{viewBox:"0 0 400 400",content:'<circle cx="200" cy="200" r="100" stroke="black" stroke-width="8" fill="none"/><rect x="150" y="30" width="100" height="60" stroke="black" stroke-width="8" fill="none" rx="5"/><rect x="150" y="310" width="100" height="60" stroke="black" stroke-width="8" fill="none" rx="5"/><rect x="30" y="150" width="60" height="100" stroke="black" stroke-width="8" fill="none" rx="5"/><rect x="310" y="150" width="60" height="100" stroke="black" stroke-width="8" fill="none" rx="5"/>'},television:{viewBox:"0 0 256 64",content:'<line x1="0" y1="56" x2="256" y2="56" stroke="black" stroke-width="16"/><rect x="32" y="16" width="192" height="40" rx="4" stroke="black" stroke-width="16" fill="none"/><rect x="40" y="24" width="176" height="24" rx="2" stroke="black" stroke-width="8" fill="none"/>'},toilet:{viewBox:"0 0 300 400",content:'<rect x="75" y="30" width="150" height="80" rx="10" stroke="black" stroke-width="8" fill="none"/><path d="M 75 110 C 75 110, 50 160, 50 210 C 50 310, 125 360, 150 360 C 175 360, 250 310, 250 210 C 250 160, 225 110, 225 110 Z" stroke="black" stroke-width="8" fill="none"/><path d="M 100 150 C 100 150, 75 190, 75 220 C 75 300, 125 340, 150 340 C 175 340, 225 300, 225 220 C 225 190, 200 150, 200 150 Z" stroke="black" stroke-width="8" fill="none"/><circle cx="150" cy="70" r="15" stroke="black" stroke-width="8" fill="none"/>'}},Xt=[{type:"svg",icon:"armchair",label:"furniture.armchair",defaultWidth:800,defaultHeight:800},{type:"svg",icon:"bath",label:"furniture.bath",defaultWidth:1700,defaultHeight:700},{type:"svg",icon:"bed-double",label:"furniture.double_bed",defaultWidth:1600,defaultHeight:2e3},{type:"svg",icon:"bed-single",label:"furniture.single_bed",defaultWidth:900,defaultHeight:2e3},{type:"svg",icon:"door-left",label:"furniture.door_left_swing",defaultWidth:800,defaultHeight:800},{type:"svg",icon:"door-right",label:"furniture.door_right_swing",defaultWidth:800,defaultHeight:800},{type:"svg",icon:"table-dining-room",label:"furniture.dining_table",defaultWidth:1600,defaultHeight:900},{type:"svg",icon:"table-dining-room-round",label:"furniture.round_table",defaultWidth:1e3,defaultHeight:1e3},{type:"svg",icon:"floor-lamp",label:"furniture.lamp",defaultWidth:400,defaultHeight:400},{type:"svg",icon:"oven",label:"furniture.oven_stove",defaultWidth:600,defaultHeight:600},{type:"svg",icon:"plant",label:"furniture.plant",defaultWidth:400,defaultHeight:400},{type:"svg",icon:"shower",label:"furniture.shower",defaultWidth:900,defaultHeight:900},{type:"svg",icon:"sofa-two-seater",label:"furniture.sofa_2_seat",defaultWidth:1600,defaultHeight:800},{type:"svg",icon:"sofa-three-seater",label:"furniture.sofa_3_seat",defaultWidth:2400,defaultHeight:800},{type:"svg",icon:"television",label:"furniture.tv",defaultWidth:1200,defaultHeight:200},{type:"svg",icon:"toilet",label:"furniture.toilet",defaultWidth:400,defaultHeight:700},{type:"icon",icon:"mdi:countertop",label:"furniture.counter",defaultWidth:2e3,defaultHeight:600,lockAspect:!1},{type:"icon",icon:"mdi:cupboard",label:"furniture.cupboard",defaultWidth:1e3,defaultHeight:500,lockAspect:!1},{type:"icon",icon:"mdi:desk",label:"furniture.desk",defaultWidth:1400,defaultHeight:700,lockAspect:!1},{type:"icon",icon:"mdi:fridge",label:"furniture.fridge",defaultWidth:700,defaultHeight:700,lockAspect:!0},{type:"icon",icon:"mdi:speaker",label:"furniture.speaker",defaultWidth:300,defaultHeight:300,lockAspect:!0},{type:"icon",icon:"mdi:window-open-variant",label:"furniture.window",defaultWidth:1e3,defaultHeight:150,lockAspect:!1}],Yt=["corners.front_left","corners.front_right","corners.back_right","corners.back_left"],Kt=[["corners.left_wall","corners.front_wall"],["corners.right_wall","corners.front_wall"],["corners.right_wall","corners.back_wall"],["corners.left_wall","corners.back_wall"]],qt=["#2196F3","#FF5722","#4CAF50"],Jt=100,Qt=Math.PI/3,te=Ft*Math.sin(Math.PI/3);class ee extends ct{constructor(){super(...arguments),this.furniture=[],this.selectedFurnitureId=null,this.hass=void 0,this.localize=t=>t,this.showCustomIconPicker=!1,this.customIconValue=""}render(){return this._renderFurnitureSidebar()}_renderFurnitureSidebar(){const t=this.furniture.find(t=>t.id===this.selectedFurnitureId);return W`
			...
			<div class="furn-catalog">
				${Xt.map(t=>W`
						<button class="furn-sticker" @click=${()=>this._fireAdd(t)}>
							${"svg"===t.type&&jt[t.icon]?Z`<svg viewBox="${jt[t.icon].viewBox}" class="furn-sticker-svg">
										${Rt(jt[t.icon].content)}
		...
		`],t([ut({attribute:!1})],ee.prototype,"furniture",void 0),t([ut({attribute:!1})],ee.prototype,"selectedFurnitureId",void 0),t([ut({attribute:!1})],ee.prototype,"hass",void 0),t([ut({attribute:!1})],ee.prototype,"localize",void 0),t([ut({attribute:!1})],ee.prototype,"showCustomIconPicker",void 0),t([ut({attribute:!1})],ee.prototype,"customIconValue",void 0),customElements.get("epp-furniture-sidebar")||customElements.define("epp-furniture-sidebar",ee);class ie extends ct{constructor(){super(...arguments),this.sidebarTab="zones",this.zoneConfigs=[],this.activeZone=null,this.roomType="normal",this.roomTrigger=0,this.roomRenew=0,this.roomTimeout=0,this.roomHandoffTimeout=0,this.roomEntryPoint=!1,this.localZoneState=new Map,this.furniture=[],this.selectedFurnitureId=null,this.hass=null,this.showCustomIconPicker=!1,this.customIconValue="",this.localize=t=>t,this.headerTemplate=j,this.gridTemplate=j,this.debugLogTemplate=j,this.saveCancelTemplate=j}render(){return W`
    ...
    `}}function oe(t,e){return t/Nt*(e+1)}function re(t,e){return t/(e+1)*Nt}function se(t,e,i){const o=i-e;return Math.round((t+o+360)%360)}ie.styles=[$t,n`
    :host {
      display: block;
    }
  ...
  `],t([ut({attribute:!1})],ie.prototype,"sidebarTab",void 0),t([ut({attribute:!1})],ie.prototype,"zoneConfigs",void 0),t([ut({attribute:!1})],ie.prototype,"activeZone",void 0),t([ut({attribute:!1})],ie.prototype,"roomType",void 0),t([ut({type:Number})],ie.prototype,"roomTrigger",void 0),t([ut({type:Number})],ie.prototype,"roomRenew",void 0),t([ut({type:Number})],ie.prototype,"roomTimeout",void 0),t([ut({type:Number})],ie.prototype,"roomHandoffTimeout",void 0),t([ut({type:Boolean})],ie.prototype,"roomEntryPoint",void 0),t([ut({attribute:!1})],ie.prototype,"localZoneState",void 0),t([ut({attribute:!1})],ie.prototype,"furniture",void 0),t([ut({attribute:!1})],ie.prototype,"selectedFurnitureId",void 0),t([ut({attribute:!1})],ie.prototype,"hass",void 0),t([ut({type:Boolean})],ie.prototype,"showCustomIconPicker",void 0),t([ut({attribute:!1})],ie.prototype,"customIconValue",void 0),t([ut({attribute:!1})],ie.prototype,"localize",void 0),t([ut({attribute:!1})],ie.prototype,"headerTemplate",void 0),t([ut({attribute:!1})],ie.prototype,"gridTemplate",void 0),t([ut({attribute:!1})],ie.prototype,"debugLogTemplate",void 0),t([ut({attribute:!1})],ie.prototype,"saveCancelTemplate",void 0),customElements.get("epp-editor-view")||customElements.define("epp-editor-view",ie);class ne extends ct{constructor(){super(...arguments),this.furniture=[],this.selectedFurnitureId=null,this.roomWidth=3e3,this.cellPx=28,this.minCol=0,this.minRow=0,this.visCols=20,this.visRows=20,this.sidebarTab="zones",this.localize=t=>t}_mmToPx(t){return oe(t,this.cellPx)}_fireEvent(t,e){this.dispatchEvent(new CustomEvent(t,{bubbles:!0,composed:!0,detail:e}))}_onItemPointerDown(t,e){this._fireEvent("furniture-select",e),this._fireEvent("furniture-pointer-down",{e:t,id:e,type:"move"})}_onResizePointerDown(t,e,i){this._fireEvent("furniture-pointer-down",{e:t,id:e,type:"resize",handle:i})}_onRotatePointerDown(t,e){this._fireEvent("furniture-pointer-down",{e:t,id:e,type:"rotate"})}_onDeletePointerDown(t,e){t.stopPropagation(),this._fireEvent("furniture-delete",e)}render(){if(!this.furniture.length)return j;const t=Math.ceil(this.roomWidth/Nt),e=Math.floor((Bt-t)/2),i=this.cellPx+1,o="furniture"===this.sidebarTab;return W`
			<div class="furniture-overlay ${o?"":"non-interactive"}">
				${this.furniture.map(t=>{const o=(e-this.minCol)*i+this._mmToPx(t.x),r=(0-this.minRow)*i+this._mmToPx(t.y),s=this._mmToPx(t.width),n=this._mmToPx(t.height),a=this.selectedFurnitureId===t.id;return W`
						...
						>
							${"svg"===t.type&&jt[t.icon]?Z`<svg viewBox="${jt[t.icon].viewBox}" preserveAspectRatio="none" class="furn-svg">
										${Rt(jt[t.icon].content)}
		...
		`}}function ae(t,e,i,o){if(i<=0||o<=0)return null;const r=Math.ceil(i/Nt);return{col:Math.floor((Bt-r)/2)+t/Nt,row:e/Nt}}ne.styles=n`
		:host {
			display: contents;
		}
	...
	`,t([ut({attribute:!1})],ne.prototype,"furniture",void 0),t([ut({attribute:!1})],ne.prototype,"selectedFurnitureId",void 0),t([ut({type:Number})],ne.prototype,"roomWidth",void 0),t([ut({type:Number})],ne.prototype,"cellPx",void 0),t([ut({type:Number})],ne.prototype,"minCol",void 0),t([ut({type:Number})],ne.prototype,"minRow",void 0),t([ut({type:Number})],ne.prototype,"visCols",void 0),t([ut({type:Number})],ne.prototype,"visRows",void 0),t([ut({attribute:!1})],ne.prototype,"sidebarTab",void 0),t([ut({attribute:!1})],ne.prototype,"localize",void 0),customElements.get("epp-furniture-overlay")||customElements.define("epp-furniture-overlay",ne);const le=Ft*Math.sin(Math.PI/3);function ce(t,e){if(!Ut(t))return"var(--secondary-background-color, #e0e0e0)";const i=Ot(t);if(i>0&&i<=7){const t=e[i-1];if(t)return t.color}return"var(--card-background-color, #fff)"}function he(t){return{r:parseInt(t.slice(1,3),16),g:parseInt(t.slice(3,5),16),b:parseInt(t.slice(5,7),16)}}function de(t,e,i){const o=t[6]*e+t[7]*i+1;return{x:(t[0]*e+t[1]*i+t[2])/o,y:(t[3]*e+t[4]*i+t[5])/o}}function pe(t){return t?de(t,0,0):null}function ue(t,e,i,o){if(t<=0||e<=0)return 0;const r=pe(i);if(r){const e=Math.ceil(t/Nt),i=Math.floor((Bt-e)/2);let s=0;const n=Zt(o);for(let t=n.minRow;t<=n.maxRow;t++)for(let e=n.minCol;e<=n.maxCol;e++){if(!Ut(o[t*Bt+e]))continue;const n=(t+.5)*Nt,a=(e-i+.5)*Nt-r.x,l=n-r.y,c=Math.sqrt(a*a+l*l);c>s&&(s=c)}if(s>0){const t=s/1e3;return Math.ceil(2*t)/2}}const s=Math.max(t,e)/1e3;return Math.ceil(2*s)/2}function ge(t){if(0===t.length)return 0;const e=[...t].sort((t,e)=>t-e),i=Math.floor(e.length/2);return e.length%2?e[i]:(e[i-1]+e[i])/2}function me(t,e,i){const o=Zt(t);if(o.minCol>o.maxCol)return null;const r=o.maxCol-o.minCol+1,s=o.maxRow-o.minRow+1,n=r*Nt,a=s*Nt,l=pe(i),c=Math.ceil(e/Nt),h=Math.floor((Bt-c)/2),d=l?l.x:n/2,p=l?l.y:0;let u=0;for(let e=0;e<It;e++){if(!Ut(t[e]))continue;const i=e%Bt,o=Math.floor(e/Bt),r=(i-h+.5)*Nt-d,s=(o+.5)*Nt-p,n=r*r+s*s;n>u&&(u=n)}return{widthM:(n/1e3).toFixed(1),depthM:(a/1e3).toFixed(1),furthestM:(Math.sqrt(u)/1e3).toFixed(1)}}class fe extends ct{constructor(){super(...arguments),this.grid=new Uint8Array(0),this.zoneConfigs=[],this.targets=[],this.roomWidth=0,this.roomDepth=0,this.perspective=null,this.furniture=[],this.selectedFurnitureId=null,this.sidebarTab="zones",this.editable=!1,this.activeZone=null,this.showHitCounts=!1,this.occupancy={},this.targetPrevXY=[],this.heatmapColors=null,this.localize=t=>t,this.maxGridPx=480,this.widthFraction=.55,this.frozenBounds=null}render(){const t=this.frozenBounds??Wt(this.grid),e=t.minCol>t.maxCol,i=e?0:t.minCol,o=e?19:t.maxCol,r=e?0:t.minRow,s=t.maxRow,n=o-i+1,a=s-r+1,l=this.offsetWidth||this.parentElement?.offsetWidth||800,c=Math.min(this.maxGridPx,l*this.widthFraction),h=Math.min(Math.floor(c/n),Math.floor(c/a),32);return W`
		...
		`}_renderVisibleCells(t,e,i,o,r){const s=this.heatmapColors,n=this.occupancy,a=[];for(let l=i;l<=o;l++)for(let i=t;i<=e;i++){const t=l*Bt+i,e=this.grid[t];let o=ce(e,this.zoneConfigs),c="";if(Ut(e)){const t=Ot(e);if(s){const e=s.get(t);e&&(o=`linear-gradient(${e}, ${e}), linear-gradient(${o}, ${o})`)}n[t]&&(c="box-shadow: inset 0 0 0 1px rgba(0,0,0,0.4);")}a.push(W`
					<div
						class="cell"
			...
			<div class="targets-overlay" style="pointer-events: none;">
				${this.targets.map((r,s)=>{if("inactive"===r.status)return j;let n=null!=r.x?ae(r.x,r.y,this.roomWidth,this.roomDepth):null;const a=n&&n.col>=t&&n.col<=t+i&&n.row>=e&&n.row<=e+o;if("pending"===r.status&&!a&&this.targetPrevXY[s]&&(n=ae(this.targetPrevXY[s].x,this.targetPrevXY[s].y,this.roomWidth,this.roomDepth)),!n)return j;const l=Math.max(0,Math.min(100,(n.col-t)/i*100)),c=Math.max(0,Math.min(100,(n.row-e)/o*100));return W`
						<div
							class="target-dot"
							style="left: ${l}%; top: ${c}%; background: ${qt[s]||qt[0]}; opacity: ${"pending"===r.status?.3:1}; transition: opacity 0.5s ease;"
						></div>
  ...
  `,t([ut({attribute:!1})],be.prototype,"sensorState",void 0),t([ut({attribute:!1})],be.prototype,"zoneState",void 0),t([ut({attribute:!1})],be.prototype,"zoneConfigs",void 0),t([ut({attribute:!1})],be.prototype,"perspective",void 0),t([ut({attribute:!1})],be.prototype,"localize",void 0),t([gt()],be.prototype,"_expandedSensorInfo",void 0),customElements.define("epp-live-sidebar",be);class _e extends ct{constructor(){super(...arguments),this.perspective=null,this.sensorState={occupancy:!1,static_presence:!1,motion_presence:!1,target_presence:!1,illuminance:null,temperature:null,humidity:null,co2:null},this.zoneState={occupancy:{},target_counts:{},frame_count:0},this.zoneConfigs=[],this.localize=t=>t,this.headerTemplate=j,this.gridTemplate=j,this.debugLogTemplate=j,this.showMenu=!1}render(){return W`
    ...
    `}_fireNavigate(t,e){this.dispatchEvent(new CustomEvent("navigate-view",{detail:{view:t,sidebarTab:e},bubbles:!0,composed:!0}))}_fireAction(t){this.dispatchEvent(new CustomEvent("live-view-action",{detail:{action:t},bubbles:!0,composed:!0}))}}_e.styles=[$t,n`
    :host {
      display: block;
    }
  ...
  `],t([ut({attribute:!1})],_e.prototype,"perspective",void 0),t([ut({attribute:!1})],_e.prototype,"sensorState",void 0),t([ut({attribute:!1})],_e.prototype,"zoneState",void 0),t([ut({attribute:!1})],_e.prototype,"zoneConfigs",void 0),t([ut({attribute:!1})],_e.prototype,"localize",void 0),t([ut({attribute:!1})],_e.prototype,"headerTemplate",void 0),t([ut({attribute:!1})],_e.prototype,"gridTemplate",void 0),t([ut({attribute:!1})],_e.prototype,"debugLogTemplate",void 0),t([gt()],_e.prototype,"showMenu",void 0),customElements.get("epp-live-view")||customElements.define("epp-live-view",_e);class ve extends ct{constructor(){super(...arguments),this.sensorState={occupancy:!1,static_presence:!1,motion_presence:!1,target_presence:!1,illuminance:null,temperature:null,humidity:null,co2:null},this.targetAutoRange=!0,this.targetMaxDistance=6,this.staticAutoRange=!0,this.staticMinDistance=.3,this.staticMaxDistance=16,this.openAccordions=new Set,this.perspective=null,this.roomWidth=0,this.roomDepth=0,this.grid=new Uint8Array(0),this.saving=!1,this.dirty=!1,this.reportingConfig={},this.offsetsConfig={},this.localize=t=>t}render(){return W`
    ...
    ><ha-icon icon="mdi:help-circle-outline"></ha-icon><span class="setting-info-tooltip">${t}</span></span>`}renderDetectionRanges(){const t=ue(this.roomWidth,this.roomDepth,this.perspective,this.grid),e=me(this.grid,this.roomWidth,this.perspective),i=this.targetAutoRange?t>0?Math.min(t,6):6:this.targetMaxDistance,o=this.staticAutoRange?t>0?Math.min(t,16):16:this.staticMaxDistance,r="opacity: 0.5; pointer-events: none;";return W`
    ...
    `}_fireChange(t,e){this.dispatchEvent(new CustomEvent("setting-change",{detail:{key:t,value:e},bubbles:!0,composed:!0}))}_fireDirty(){this.dispatchEvent(new CustomEvent("dirty",{bubbles:!0,composed:!0}))}}ve.styles=[vt,_t,yt,wt,zt,n`
      :host {
        display: block;
      }
          ...
          <div style="display: flex; flex-direction: column; gap: 14px; padding: 16px 4px 0;">
            <div style="display: flex; align-items: flex-start; gap: 10px;">
              ...
              <div style="font-size: 13px;">
                ${Dt(this.localize("wizard.walk_instruction_full"))}
              </div>
            </div>
            ...
            <div style="display: flex; align-items: flex-start; gap: 10px;">
              ...
              <div style="font-size: 13px;">
                ${Dt(this.localize("wizard.cant_reach"))}
              </div>
            </div>
    ...
    `}_renderWizardCorners(){const t=this._wizardCornerIndex,e=this.rawTargets.filter(t=>null!=t.raw_x&&null!=t.raw_y),i=e.length>0,o=e.length>1,r=this._wizardCorners.every(t=>null!==t),s=Yt[t]||"",[n,a]=Kt[t]||["",""];return W`
      <div class="wizard-card">
        ...
        <div class="corner-progress">
          ${Yt.map((e,i)=>{const o=!!this._wizardCorners[i],r=i<3,s=i<t;return W`
                <span
    ...
    `}_renderMiniSensorView(){const t=te,e=Ft,i=200,o=-t,r=e*Math.cos(Qt),s=`M 0 0 L ${o} ${r} A 6000 6000 0 0 0 ${t} ${r} Z`,n=[2e3,4e3].map(t=>{const e=t*Math.sin(Qt),i=t*Math.cos(Qt);return`M ${-e} ${i} A ${t} ${t} 0 0 0 ${e} ${i}`});return W`
        ...
        <div class="sensor-fov-view">
          ...
          ${this.rawTargets.map((t,e)=>null!=t.raw_x&&null!=t.raw_y?W`
              <div
                ...
                style="${this._getWizardTargetStyle(t)} background: ${qt[e]||qt[0]};"
              ></div>
            `:j)}
        </div>
      </div>
    `}_renderUncalibratedFov(){const t=this.sensorState.occupancy,e=t?"#4CAF50":"var(--primary-color, #03a9f4)",i=160,o=14,r=180,s=30*Math.PI/180,n=150*Math.PI/180,a=i+r*Math.cos(s),l=o+r*Math.sin(s),c=i+r*Math.cos(n),h=o+r*Math.sin(n);return W`
      <div style="display: flex; flex-direction: column; align-items: center; padding: 24px;">
        <svg viewBox="0 0 320 210" width="320" height="210" style="display: block;">
          ...
          <!-- Target dots -->
          ${this.rawTargets.map((t,e)=>{if(null==t.raw_x||null==t.raw_y)return j;const s=Math.sqrt(t.raw_x*t.raw_x+t.raw_y*t.raw_y),n=Math.atan2(t.raw_x,t.raw_y),a=Math.min(s/6e3,1)*r,l=Math.PI/2-n,c=i+a*Math.cos(l),h=o+a*Math.sin(l);return Z`<circle cx="${c}" cy="${h}" r="5" fill="${qt[e]||qt[0]}"/>`})}
          ...
          <div style="display: flex; flex-direction: column; gap: 20px; padding: 8px 0;">
            ...
            <div style="display: flex; align-items: center; gap: 16px;">
              ...
              <div>
                ...
                <div style="font-size: 13px; color: var(--secondary-text-color, #757575);">
                  ${Dt(this.localize("wizard.mount_height_desc"))}
                </div>
              </div>
            </div>
            ...
            <div style="display: flex; align-items: center; gap: 16px;">
              ...
              <div>
                ...
                <div style="font-size: 13px; color: var(--secondary-text-color, #757575);">
                  ${Dt(this.localize("wizard.placement_desc"))}
                </div>
              </div>
            </div>
            ...
            <div style="display: flex; align-items: center; gap: 16px;">
              ...
              <div>
                ...
                <div style="font-size: 13px; color: var(--secondary-text-color, #757575);">
                  ${Dt(this.localize("wizard.beam_direction_desc"))}
                </div>
              </div>
            </div>
    ...
    `}_fireStartCalibration(){this.dispatchEvent(new CustomEvent("start-calibration",{bubbles:!0,composed:!0}))}_fireCancel(){this._setupStep=null,this._wizardCorners=[null,null,null,null],this._wizardCornerIndex=0,this._wizardOffsetSide="",this._wizardOffsetFb="",this.dispatchEvent(new CustomEvent("wizard-cancel",{bubbles:!0,composed:!0}))}}ye.styles=[_t,$t,yt,n`
      :host {
        display: block;
      }
    ...
    `}_renderProtocolBanner(){const t=this._devices.find(t=>t.mac===this._selectedMac);if(!t||"compatible"===t.config_protocol_status)return j;const e="firmware_behind"===t.config_protocol_status,i=e?this._localize("protocol.firmware_behind"):this._localize("protocol.firmware_ahead");return W`
			<div class="protocol-fullpage protocol-fullpage-${e?"warning":"info"}">
				<ha-icon icon=${e?"mdi:alert-circle-outline":"mdi:information-outline"}></ha-icon>
				<p>${i}</p>
				${e?W`<button class="wizard-btn wizard-btn-primary"
						@click=${()=>this._updateFirmware()}
					>${this._localize("protocol.update_firmware")}</button>`:j}
			</div>
		`}async _updateFirmware(){if(this._selectedMac&&this.hass)try{await this.hass.callWS({type:"eppgrid/update_firmware",mac:this._selectedMac})}catch(t){console.error("Firmware update failed:",t)}}_renderLiveGrid(){for(let t=0;t<this._targets.length;t++){const e=this._targets[t];null!=e.x&&null!=e.y&&"active"===e.status&&(this._zoneEngineState.targetPrevXY[t]={x:e.x,y:e.y})}const t={};for(const[e,i]of Object.entries(this._zoneState.occupancy))t[Number(e)]=i;return W`
			<epp-grid
				.grid=${this._grid}
    ...
    `}_renderLiveOverview(){return W`
      ...
      ></epp-live-view>
    `}_toggleAccordion(t){this._openAccordions=this._openAccordions.has(t)?new Set:new Set([t])}_getSensorRoomPosition(){return pe(this._perspective)}_autoDetectionRange(){return ue(this._roomWidth,this._roomDepth,this._perspective,this._grid)}_renderSettings(){return W`
      <div class="panel">
        ${this._renderHeader()}
        <epp-settings-view
          .sensorState=${this._sensorState}
    ...
    `}_renderFurnitureOverlay(t,e,i,o,r){return this._furniture.length?W`
			<epp-furniture-overlay
				...
				@furniture-delete=${t=>{this._removeFurniture(t.detail)}}
			></epp-furniture-overlay>
		`:j}}Fi.styles=[mt,ft,bt,_t,$t,xt,n`
    .cell {
      cursor: pointer;
      transition: opacity 0.1s;
    }
