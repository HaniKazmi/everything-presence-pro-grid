...
`;class oe extends ct{constructor(){super(...arguments),this.furniture=[],this.selectedFurnitureId=null,this.hass=void 0,this.localize=t=>t,this.showCustomIconPicker=!1,this.customIconValue=""}render(){return this._renderFurnitureSidebar()}_renderFurnitureSidebar(){const t=this.furniture.find(t=>t.id===this.selectedFurnitureId);return G`
		...
		`}_renderVisibleCells(t,e,i,o,s){const r=this.heatmapColors,n=this.occupancy,a=[];for(let l=i;l<=o;l++)for(let i=t;i<=e;i++){const t=l*xt+i,e=this.grid[t];let o=ne(e,this.zoneConfigs),c="";if(Tt(e)){const t=Et(e);if(r){const e=r.get(t);e&&(o=`linear-gradient(${e}, ${e}), linear-gradient(${o}, ${o})`)}n[t]&&(c="box-shadow: inset 0 0 0 1px rgba(0,0,0,0.4);")}a.push(G`
					<div
						class="cell"
			...
			<div class="targets-overlay" style="pointer-events: none;">
				${this.targets.map((s,r)=>{if("inactive"===s.status)return V;let n=null!=s.x?se(s.x,s.y,this.roomWidth,this.roomDepth):null;const a=n&&n.col>=t&&n.col<=t+i&&n.row>=e&&n.row<=e+o;if("pending"===s.status&&!a&&this.targetPrevXY[r]&&(n=se(this.targetPrevXY[r].x,this.targetPrevXY[r].y,this.roomWidth,this.roomDepth)),!n)return V;const l=Math.max(0,Math.min(100,(n.col-t)/i*100)),c=Math.max(0,Math.min(100,(n.row-e)/o*100));return G`
						<div
							class="target-dot"
							style="left: ${l}%; top: ${c}%; background: ${Lt[r]||Lt[0]}; opacity: ${"pending"===s.status?.3:1}; transition: opacity 0.5s ease;"
						></div>
  ...
  `,t([pt({attribute:!1})],ge.prototype,"sensorState",void 0),t([pt({attribute:!1})],ge.prototype,"zoneState",void 0),t([pt({attribute:!1})],ge.prototype,"zoneConfigs",void 0),t([pt({attribute:!1})],ge.prototype,"perspective",void 0),t([pt({attribute:!1})],ge.prototype,"localize",void 0),t([gt()],ge.prototype,"_expandedSensorInfo",void 0),customElements.get("epp-live-sidebar")||customElements.define("epp-live-sidebar",ge);class me extends ct{constructor(){super(...arguments),this.sensorState={occupancy:!1,static_presence:!1,motion_presence:!1,target_presence:!1,illuminance:null,temperature:null,humidity:null,co2:null},this.targetAutoDistance=!0,this.targetMaxDistance=6,this.staticAutoDistance=!0,this.staticMinDistance=.3,this.staticMaxDistance=16,this.openAccordions=new Set,this.perspective=null,this.roomWidth=0,this.roomDepth=0,this.grid=new Uint8Array(0),this.saving=!1,this.dirty=!1,this.temperatureOffset=0,this.humidityOffset=0,this.illuminanceOffset=0,this.motionTimeout=5,this.staticTimeout=30,this.staticTriggerThreshold=3,this.staticRenewThreshold=3,this.staticOnDelay=0,this.entitiesConfig={},this.logLevels={},this.bluetoothEnabled=!1,this.co2Enabled=!1,this.ledMode="Manual Control",this.ledBrightness=1,this.ledPresenceColor="#CC33FF",this.relayTriggerMode="disabled",this.relayContactMode="no",this.targetUpdateRateMs=1e3,this.zoneUpdateRateMs=1e3,this._overrides={},this.localize=t=>t}render(){return G`
    ...
    `}_renderWizardCorners(){const t=this._wizardCornerIndex,e=this.rawTargets.filter(t=>null!=t.raw_x&&null!=t.raw_y),i=e.length>0,o=e.length>1,s=this._wizardCorners.every(t=>null!==t),r=Rt[t]||"",[n,a]=Bt[t]||["",""];return G`
      <div class="wizard-card">
        ...
        <div class="corner-progress">
          ${Rt.map((e,i)=>{const o=!!this._wizardCorners[i],s=i<3,r=i<t;return G`
                <span
    ...
    `}_renderUncalibratedFov(){const t=this.sensorState.occupancy,e=t?"#4CAF50":"var(--primary-color, #03a9f4)",i=160,o=14,s=180,r=30*Math.PI/180,n=150*Math.PI/180,a=i+s*Math.cos(r),l=o+s*Math.sin(r),c=i+s*Math.cos(n),h=o+s*Math.sin(n);return G`
      <div style="display: flex; flex-direction: column; align-items: center; padding: 24px;">
        <svg viewBox="0 0 320 210" width="320" height="210" style="display: block;">
          ...
          <!-- Target dots -->
          ${this.rawTargets.map((t,e)=>{if(null==t.raw_x||null==t.raw_y)return V;const r=Math.sqrt(t.raw_x*t.raw_x+t.raw_y*t.raw_y),n=Math.atan2(t.raw_x,t.raw_y),a=Math.min(r/6e3,1)*s,l=Math.PI/2-n,c=i+a*Math.cos(l),h=o+a*Math.sin(l);return Z`<circle cx="${c}" cy="${h}" r="5" fill="${Lt[e]||Lt[0]}"/>`})}
    ...
    `}_fireStartCalibration(){this.dispatchEvent(new CustomEvent("start-calibration",{bubbles:!0,composed:!0}))}_fireCancel(){this._setupStep=null,this._wizardCorners=[null,null,null,null],this._wizardCornerIndex=0,this._wizardOffsetSide="",this._wizardOffsetFb="",this.dispatchEvent(new CustomEvent("wizard-cancel",{bubbles:!0,composed:!0}))}}_e.styles=[Xt,Qt,Kt,n`
      :host {
        display: block;
      }
    ...
    `],t([pt({attribute:!1})],_e.prototype,"hass",void 0),t([pt({type:String})],_e.prototype,"selectedMac",void 0),t([pt({attribute:!1})],_e.prototype,"rawTargets",void 0),t([pt({attribute:!1})],_e.prototype,"sensorState",void 0),t([pt({attribute:!1})],_e.prototype,"devices",void 0),t([pt({attribute:!1})],_e.prototype,"localize",void 0),t([pt({type:Number})],_e.prototype,"initialRoomWidth",void 0),t([pt({type:Number})],_e.prototype,"initialRoomDepth",void 0),t([pt({type:String})],_e.prototype,"mode",void 0),t([gt()],_e.prototype,"_setupStep",void 0),t([gt()],_e.prototype,"_wizardSaving",void 0),t([gt()],_e.prototype,"_wizardCornerIndex",void 0),t([gt()],_e.prototype,"_wizardCorners",void 0),t([gt()],_e.prototype,"_wizardRoomWidth",void 0),t([gt()],_e.prototype,"_wizardRoomDepth",void 0),t([gt()],_e.prototype,"_wizardCapturing",void 0),t([gt()],_e.prototype,"_wizardCaptureProgress",void 0),t([gt()],_e.prototype,"_wizardCapturePaused",void 0),t([gt()],_e.prototype,"_wizardOffsetSide",void 0),t([gt()],_e.prototype,"_wizardOffsetFb",void 0),customElements.get("epp-wizard")||customElements.define("epp-wizard",_e);const fe={normal:{trigger:5,renew:3,timeout:10,handoff_timeout:3},entrance:{trigger:3,renew:2,timeout:5,handoff_timeout:1},thoroughfare:{trigger:3,renew:2,timeout:3,handoff_timeout:1},rest:{trigger:7,renew:1,timeout:30,handoff_timeout:10}},ve=["#E69F00","#56B4E9","#009E73","#F0E442","#0072B2","#D55E00","#CC79A7"];function be(t,e,i,o,s,r,n,a){if(0===t){const t=fe[i]||fe.normal;return"custom"===i?{trigger:o,renew:s,timeout:r,handoffTimeout:n,entryPoint:a}:{trigger:t.trigger,renew:t.renew,timeout:t.timeout,handoffTimeout:t.handoff_timeout,entryPoint:!1}}if(t>0&&t<=e.length){const i=e[t-1];if(i){const t=fe[i.type]||fe.normal;return"custom"===i.type?{trigger:i.trigger??t.trigger,renew:i.renew??t.renew,timeout:i.timeout??t.timeout,handoffTimeout:i.handoff_timeout??t.handoff_timeout,entryPoint:i.entry_point??!1}:{trigger:t.trigger,renew:t.renew,timeout:t.timeout,handoffTimeout:t.handoff_timeout,entryPoint:"entrance"===i.type}}}return{trigger:5,renew:3,timeout:10,handoffTimeout:3,entryPoint:!1}}class ye extends ct{constructor(){super(...arguments),this.zoneConfigs=[],this.activeZone=null,this.roomType="normal",this.roomTrigger=fe.normal.trigger,this.roomRenew=fe.normal.renew,this.roomTimeout=fe.normal.timeout,this.roomHandoffTimeout=fe.normal.handoff_timeout,this.roomEntryPoint=!1,this.localZoneState=new Map,this.localize=t=>t}render(){return this._renderZoneSidebar()}_renderZoneSidebar(){return G`
			...
			>
				...
				>
					...
					<select
						...
						.value=${this.roomType}
						@change=${t=>{const e=t.target.value,i=fe[e]||fe.normal;this.dispatchEvent(new CustomEvent("room-config-change",{detail:{updates:{roomType:e,roomTrigger:i.trigger,roomRenew:i.renew,roomTimeout:i.timeout,roomHandoffTimeout:i.handoff_timeout}},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("dirty",{bubbles:!0,composed:!0}))}}
						@click=${t=>t.stopPropagation()}
					>
						<option value="normal">
		...
		`}_renderZoneTypeControls(t,e){const i="custom"===t.type,o=fe[t.type]||fe.normal,s=t.trigger??o.trigger,r=t.renew??o.renew,n=t.timeout??o.timeout,a=t.handoff_timeout??o.handoff_timeout,l=`width: 100%; display: flex; align-items: center; gap: 4px; font-size: 12px; opacity: ${i?1:.5};`;return G`
			<div
				class="zone-item-row zone-settings-row"
				style="flex-wrap: wrap; gap: 3px; padding: 4px 8px;"
			>
				...
				>
					...
					<select
						...
						style="flex: 1; min-width: 0;"
						.value=${t.type}
						@change=${t=>{const i=t.target.value,o=fe[i]||fe.normal;this.dispatchEvent(new CustomEvent("zone-config-change",{detail:{index:e,updates:{type:i,trigger:o.trigger,renew:o.renew,timeout:o.timeout,handoff_timeout:o.handoff_timeout}},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("dirty",{bubbles:!0,composed:!0}))}}
						@click=${t=>t.stopPropagation()}
					>
						<option value="normal">
							${this.localize("zones.normal")}
