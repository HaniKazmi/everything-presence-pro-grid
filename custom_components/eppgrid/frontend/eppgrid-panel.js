		...
		`}_renderVisibleCells(t,e,i,o,s){const r=this.heatmapColors,n=this.occupancy,a=[];for(let l=i;l<=o;l++)for(let i=t;i<=e;i++){const t=l*wt+i,e=this.grid[t];let o=ne(e,this.zoneConfigs),c="";if(Tt(e)){const t=Ct(e);if(r){const e=r.get(t);e&&(o=`linear-gradient(${e}, ${e}), linear-gradient(${o}, ${o})`)}n[t]&&(c="box-shadow: inset 0 0 0 1px rgba(0,0,0,0.4);")}a.push(G`
			...
			<div class="targets-overlay" style="pointer-events: none;">
				${this.targets.map((s,r)=>{if("inactive"===s.status)return V;let n=null!=s.x?se(s.x,s.y,this.roomWidth,this.roomDepth):null;const a=n&&n.col>=t&&n.col<=t+i&&n.row>=e&&n.row<=e+o;if("pending"===s.status&&!a&&this.targetPrevXY[r]&&(n=se(this.targetPrevXY[r].x,this.targetPrevXY[r].y,this.roomWidth,this.roomDepth)),!n)return V;const l=Math.max(0,Math.min(100,(n.col-t)/i*100)),c=Math.max(0,Math.min(100,(n.row-e)/o*100));return G`
						<div
							class="target-dot"
							style="left: ${l}%; top: ${c}%; background: ${Bt[r]||Bt[0]}; opacity: ${"pending"===s.status?.3:1}; transition: opacity 0.5s ease;"
						></div>
      ...
      <div class="settings-section">
        ...
        <div class="setting-group">
          ...
          <div class="setting-row">
            ...
            <label class="toggle-switch"><input type="checkbox" @change=${t=>{const e=t.target,i=e.dataset.entityKey;this._overrides.entities||(this._overrides.entities={}),this._overrides.entities[i]=e.checked,this._fireDirty()}} data-entity-key="target_xy" .checked=${i("target_xy",!1)} /><span class="toggle-slider"></span></label>
        ...
        <div class="sensor-fov-view">
          ...
          ${this.rawTargets.map((t,e)=>null!=t.raw_x&&null!=t.raw_y?G`
              <div
                ...
                style="${this._getWizardTargetStyle(t)} background: ${Bt[e]||Bt[0]};"
              ></div>
            `:V)}
        </div>
      </div>
    `}_renderUncalibratedFov(){const t=this.sensorState.occupancy,e=t?"#4CAF50":"var(--primary-color, #03a9f4)",i=160,o=14,s=180,r=30*Math.PI/180,n=150*Math.PI/180,a=i+s*Math.cos(r),l=o+s*Math.sin(r),c=i+s*Math.cos(n),h=o+s*Math.sin(n);return G`
      <div style="display: flex; flex-direction: column; align-items: center; padding: 24px;">
        <svg viewBox="0 0 320 210" width="320" height="210" style="display: block;">
          ...
          <!-- Target dots -->
          ${this.rawTargets.map((t,e)=>{if(null==t.raw_x||null==t.raw_y)return V;const r=Math.sqrt(t.raw_x*t.raw_x+t.raw_y*t.raw_y),n=Math.atan2(t.raw_x,t.raw_y),a=Math.min(r/6e3,1)*s,l=Math.PI/2-n,c=i+a*Math.cos(l),h=o+a*Math.sin(l);return Z`<circle cx="${c}" cy="${h}" r="5" fill="${Bt[e]||Bt[0]}"/>`})}
