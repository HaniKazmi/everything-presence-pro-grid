...
`;class ne extends ct{constructor(){super(...arguments),this.furniture=[],this.selectedFurnitureId=null,this.hass=void 0,this.localize=t=>t,this.showCustomIconPicker=!1,this.customIconValue=""}render(){return this._renderFurnitureSidebar()}_renderFurnitureSidebar(){const t=this.furniture.find(t=>t.id===this.selectedFurnitureId);return W`
		...
		`}_renderVisibleCells(t,e,i,o,s){const r=this.heatmapColors,n=this.occupancy,a=[];for(let l=i;l<=o;l++)for(let i=t;i<=e;i++){const t=l*wt+i,e=this.grid[t];let o=ce(e,this.zoneConfigs),c="";if(Tt(e)){const t=Et(e);if(r){const e=r.get(t);e&&(o=`linear-gradient(${e}, ${e}), linear-gradient(${o}, ${o})`)}n[t]&&(c="box-shadow: inset 0 0 0 1px rgba(0,0,0,0.4);")}let h="";if(Tt(e))if(St(e))h="background-image: repeating-linear-gradient(45deg, transparent, transparent 6px, rgba(60,60,60,0.7) 6px, rgba(60,60,60,0.7) 8px);";else{const t=Dt(e);7===t?h="background-image: repeating-linear-gradient(-45deg, transparent, transparent 5px, #cc3333 5px, #cc3333 7px), repeating-linear-gradient(45deg, transparent, transparent 5px, #cc3333 5px, #cc3333 7px);":t>0&&(h="background-image: repeating-linear-gradient(-45deg, transparent, transparent 5px, #cc3333 5px, #cc3333 7px);")}a.push(W`
					<div
						class="cell"
		...
		`}_renderGridDimensions(){const t=me(this.grid,this.roomWidth,this.perspective);return t?W`
  ...
  `,t([pt({attribute:!1})],_e.prototype,"sensorState",void 0),t([pt({attribute:!1})],_e.prototype,"zoneState",void 0),t([pt({attribute:!1})],_e.prototype,"zoneConfigs",void 0),t([pt({attribute:!1})],_e.prototype,"perspective",void 0),t([pt({attribute:!1})],_e.prototype,"localize",void 0),t([gt()],_e.prototype,"_expandedSensorInfo",void 0),customElements.get("epp-live-sidebar")||customElements.define("epp-live-sidebar",_e);class ve extends ct{constructor(){super(...arguments),this.sensorState={occupancy:!1,static_presence:!1,motion_presence:!1,target_presence:!1,illuminance:null,temperature:null,humidity:null,co2:null},this.targetAutoDistance=!0,this.targetMaxDistance=6,this.staticAutoDistance=!0,this.staticMinDistance=.3,this.staticMaxDistance=16,this.openAccordions=new Set,this.perspective=null,this.roomWidth=0,this.roomDepth=0,this.grid=new Uint8Array(0),this.saving=!1,this.dirty=!1,this.temperatureOffset=0,this.humidityOffset=0,this.illuminanceOffset=0,this.motionTimeout=5,this.staticTimeout=30,this.staticTriggerThreshold=3,this.staticRenewThreshold=3,this.staticOnDelay=0,this.entitiesConfig={},this.logLevels={},this.bluetoothEnabled=!1,this.co2Enabled=!1,this.ledMode="Manual Control",this.ledBrightness=1,this.ledPresenceColor="#CC33FF",this.relayTriggerMode="disabled",this.relayContactMode="no",this.targetUpdateRateMs=1e3,this.zoneUpdateRateMs=1e3,this._overrides={},this.localize=t=>t}render(){return W`
    ...
    ><ha-icon icon="mdi:help-circle-outline"></ha-icon><span class="setting-info-tooltip">${t}</span></button>`}renderDetectionRanges(){const t=pe(this.roomWidth,this.roomDepth,this.perspective,this.grid),e=me(this.grid,this.roomWidth,this.perspective),i=t>0?Math.min(t,6):6,o=t>0?Math.min(t,16):16,s=this.targetAutoDistance?i:this.targetMaxDistance,r=this.staticAutoDistance?o:this.staticMaxDistance,n="opacity: 0.5; pointer-events: none;";return W`
    ...
    `}_renderWizardCorners(){const t=this._wizardCornerIndex,e=this.rawTargets.filter(t=>null!=t.raw_x&&null!=t.raw_y),i=e.length>0,o=e.length>1,s=this._wizardCorners.every(t=>null!==t),r=It[t]||"",[n,a]=Nt[t]||["",""];return W`
    ...
    `}_renderMiniSensorView(){const t=Gt,e=Ct,i=200,o=-t,s=e*Math.cos(Ut),r=`M 0 0 L ${o} ${s} A 6000 6000 0 0 0 ${t} ${s} Z`,n=[2e3,4e3].map(t=>{const e=t*Math.sin(Ut),i=t*Math.cos(Ut);return`M ${-e} ${i} A ${t} ${t} 0 0 0 ${e} ${i}`});return W`
	...
	`,t([pt({attribute:!1})],ye.prototype,"overlayMode",void 0),t([pt({attribute:!1})],ye.prototype,"localize",void 0),customElements.get("epp-overlay-sidebar")||customElements.define("epp-overlay-sidebar",ye);const xe={normal:{trigger:5,renew:3,timeout:10,handoff_timeout:3},thoroughfare:{trigger:3,renew:2,timeout:3,handoff_timeout:1},rest:{trigger:7,renew:1,timeout:30,handoff_timeout:10}},we=["#E69F00","#56B4E9","#009E73","#F0E442","#0072B2","#D55E00","#CC79A7"];function $e(t,e,i,o,s,r,n){if(0===t){const t=xe[i]||xe.normal;return"custom"===i?{trigger:o,renew:s,timeout:r,handoffTimeout:n}:{trigger:t.trigger,renew:t.renew,timeout:t.timeout,handoffTimeout:t.handoff_timeout}}if(t>0&&t<=e.length){const i=e[t-1];if(i){const t=xe[i.type]||xe.normal;return"custom"===i.type?{trigger:i.trigger??t.trigger,renew:i.renew??t.renew,timeout:i.timeout??t.timeout,handoffTimeout:i.handoff_timeout??t.handoff_timeout}:{trigger:t.trigger,renew:t.renew,timeout:t.timeout,handoffTimeout:t.handoff_timeout}}}return{trigger:5,renew:3,timeout:10,handoffTimeout:3}}class ze extends ct{constructor(){super(...arguments),this.zoneConfigs=[],this.activeZone=null,this.roomType="normal",this.roomTrigger=xe.normal.trigger,this.roomRenew=xe.normal.renew,this.roomTimeout=xe.normal.timeout,this.roomHandoffTimeout=xe.normal.handoff_timeout,this.localZoneState=new Map,this.localize=t=>t}render(){return this._renderZoneSidebar()}_renderZoneSidebar(){return W`
		...
		`}_renderZoneTypeControls(t,e){const i="custom"===t.type,o=xe[t.type]||xe.normal,s=t.trigger??o.trigger,r=t.renew??o.renew,n=t.timeout??o.timeout,a=t.handoff_timeout??o.handoff_timeout,l=`width: 100%; display: flex; align-items: center; gap: 4px; font-size: 12px; opacity: ${i?1:.5};`;return W`
			<div
				class="zone-item-row zone-settings-row"
				style="flex-wrap: wrap; gap: 3px; padding: 4px 8px;"
			>
    ...
    `}_renderProtocolBanner(){const t=this._devices.find(t=>t.mac===this._selectedMac);if(!t||"compatible"===t.config_protocol_status)return V;const e=t.config_protocol_status,i="firmware_behind"===e,o="unavailable"===e?this._localize("protocol.unavailable"):i?this._localize("protocol.firmware_behind"):this._localize("protocol.firmware_ahead");return W`
		...
		`}_retryConnection(){this._selectedMac&&this._loadDeviceConfig(this._selectedMac)}_renderLiveGrid(){for(let t=0;t<this._targets.length;t++){const e=this._targets[t];null!=e.x&&null!=e.y&&"active"===e.status&&(this._zoneEngineState.targetPrevXY[t]={x:e.x,y:e.y})}const t={};for(const[e,i]of Object.entries(this._zoneState.occupancy))t[Number(e)]=i;return W`
			...
			></epp-grid>
		`}async _markGhost(t,e){const i=ae(t,e,this._roomWidth,this._roomDepth);if(!i)return;const o=Math.floor(i.col),s=Math.floor(i.row);if(o<0||o>=wt||s<0||s>=$t)return;const r=s*wt+o,n=this._grid[r];if(!Tt(n))return;if(Dt(n)>0)return;this._grid=new Uint8Array(this._grid),this._grid[r]=At(this._grid[r],1),this._dirty=!0,await this._gridCtrl.applyLayout()}_renderSaveCancelButtons(){const t="settings"===this._view?this._saveSettings:this._applyLayout;return W`
      <div class="save-cancel-bar">
        <button class="wizard-btn wizard-btn-back"
    ...
    `}_toggleAccordion(t){this._openAccordions=this._openAccordions.has(t)?new Set:new Set([t])}_getSensorRoomPosition(){return ue(this._perspective)}_autoDetectionRange(){return pe(this._roomWidth,this._roomDepth,this._perspective,this._grid)}_renderSettings(){return W`
      <div class="panel">
        ${this._renderHeader()}
        <epp-settings-view
          .sensorState=${this._sensorState}
