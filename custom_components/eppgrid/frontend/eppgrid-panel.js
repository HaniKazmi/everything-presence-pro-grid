...
`;class ne extends ct{constructor(){super(...arguments),this.furniture=[],this.selectedFurnitureId=null,this.hass=void 0,this.localize=t=>t,this.showCustomIconPicker=!1,this.customIconValue=""}render(){return this._renderFurnitureSidebar()}_renderFurnitureSidebar(){const t=this.furniture.find(t=>t.id===this.selectedFurnitureId);return G`
		...
		`],t([pt({attribute:!1})],ne.prototype,"furniture",void 0),t([pt({attribute:!1})],ne.prototype,"selectedFurnitureId",void 0),t([pt({attribute:!1})],ne.prototype,"hass",void 0),t([pt({attribute:!1})],ne.prototype,"localize",void 0),t([pt({attribute:!1})],ne.prototype,"showCustomIconPicker",void 0),t([pt({attribute:!1})],ne.prototype,"customIconValue",void 0),customElements.get("epp-furniture-sidebar")||customElements.define("epp-furniture-sidebar",ne);const le=Tt*Math.sin(Math.PI/3);function ce(t,e){if(!Ct(t))return"var(--secondary-background-color, #e0e0e0)";const i=Et(t);if(i>0&&i<=7){const t=e[i-1];if(t)return t.color}return"var(--card-background-color, #fff)"}function he(t){return{r:parseInt(t.slice(1,3),16),g:parseInt(t.slice(3,5),16),b:parseInt(t.slice(5,7),16)}}function de(t,e,i){const o=t[6]*e+t[7]*i+1;return{x:(t[0]*e+t[1]*i+t[2])/o,y:(t[3]*e+t[4]*i+t[5])/o}}function ue(t){return t?de(t,0,0):null}function pe(t,e,i,o){if(t<=0||e<=0)return 0;const s=ue(i);if(s){const e=Math.ceil(t/kt),i=Math.floor((wt-e)/2);let r=0;const n=Ht(o);for(let t=n.minRow;t<=n.maxRow;t++)for(let e=n.minCol;e<=n.maxCol;e++){if(!Ct(o[t*wt+e]))continue;const n=(t+.5)*kt,a=(e-i+.5)*kt-s.x,l=n-s.y,c=Math.sqrt(a*a+l*l);c>r&&(r=c)}if(r>0){const t=r/1e3;return Math.ceil(2*t)/2}}const r=Math.max(t,e)/1e3;return Math.ceil(2*r)/2}function ge(t){if(0===t.length)return 0;const e=[...t].sort((t,e)=>t-e),i=Math.floor(e.length/2);return e.length%2?e[i]:(e[i-1]+e[i])/2}function me(t,e,i){const o=Ht(t);if(o.minCol>o.maxCol)return null;const s=o.maxCol-o.minCol+1,r=o.maxRow-o.minRow+1,n=s*kt,a=r*kt,l=ue(i),c=Math.ceil(e/kt),h=Math.floor((wt-c)/2),d=l?l.x:n/2,u=l?l.y:0;let p=0;for(let e=0;e<zt;e++){if(!Ct(t[e]))continue;const i=e%wt,o=Math.floor(e/wt),s=(i-h+.5)*kt-d,r=(o+.5)*kt-u,n=s*s+r*r;n>p&&(p=n)}return{widthM:(n/1e3).toFixed(1),depthM:(a/1e3).toFixed(1),furthestM:(Math.sqrt(p)/1e3).toFixed(1)}}class _e extends ct{constructor(){super(...arguments),this.grid=new Uint8Array(0),this.zoneConfigs=[],this.targets=[],this.roomWidth=0,this.roomDepth=0,this.perspective=null,this.furniture=[],this.selectedFurnitureId=null,this.sidebarTab="zones",this.editable=!1,this.activeZone=null,this.showHitCounts=!1,this.occupancy={},this.targetPrevXY=[],this.heatmapColors=null,this.localize=t=>t,this.dismissedTargets=new Map,this.maxGridPx=480,this.frozenBounds=null}render(){const t=this.frozenBounds??Pt(this.grid),e=t.minCol>t.maxCol,i=e?0:t.minCol,o=e?19:t.maxCol,s=e?0:t.minRow,r=t.maxRow,n=o-i+1,a=r-s+1,l=Math.min(Math.floor(this.maxGridPx/n),Math.floor(this.maxGridPx/a),32);return G`
		...
		`}_renderVisibleCells(t,e,i,o,s){const r=this.heatmapColors,n=this.occupancy,a=[];for(let l=i;l<=o;l++)for(let i=t;i<=e;i++){const t=l*wt+i,e=this.grid[t];let o=ce(e,this.zoneConfigs),c="";if(Ct(e)){const t=Et(e);if(r){const e=r.get(t);e&&(o=`linear-gradient(${e}, ${e}), linear-gradient(${o}, ${o})`)}n[t]&&(c="box-shadow: inset 0 0 0 1px rgba(0,0,0,0.4);")}let h="";if(Ct(e))if(St(e))h="background-image: repeating-linear-gradient(45deg, transparent, transparent 6px, rgba(60,60,60,0.7) 6px, rgba(60,60,60,0.7) 8px);";else{const t=Dt(e);7===t?h="background-image: repeating-linear-gradient(-45deg, transparent, transparent 5px, #cc3333 5px, #cc3333 7px), repeating-linear-gradient(45deg, transparent, transparent 5px, #cc3333 5px, #cc3333 7px);":t>0&&(h="background-image: repeating-linear-gradient(-45deg, transparent, transparent 5px, #cc3333 5px, #cc3333 7px);")}a.push(G`
					<div
						class="cell"
		...
		`}_renderGridDimensions(){const t=me(this.grid,this.roomWidth,this.perspective);return t?G`
  ...
  `,t([pt({attribute:!1})],fe.prototype,"sensorState",void 0),t([pt({attribute:!1})],fe.prototype,"zoneState",void 0),t([pt({attribute:!1})],fe.prototype,"zoneConfigs",void 0),t([pt({attribute:!1})],fe.prototype,"perspective",void 0),t([pt({attribute:!1})],fe.prototype,"localize",void 0),t([gt()],fe.prototype,"_expandedSensorInfo",void 0),customElements.get("epp-live-sidebar")||customElements.define("epp-live-sidebar",fe);class ve extends ct{constructor(){super(...arguments),this.sensorState={occupancy:!1,static_presence:!1,motion_presence:!1,target_presence:!1,illuminance:null,temperature:null,humidity:null,co2:null},this.targetAutoDistance=!0,this.targetMaxDistance=6,this.staticAutoDistance=!0,this.staticMinDistance=.3,this.staticMaxDistance=16,this.openAccordions=new Set,this.perspective=null,this.roomWidth=0,this.roomDepth=0,this.grid=new Uint8Array(0),this.saving=!1,this.dirty=!1,this.temperatureOffset=0,this.humidityOffset=0,this.illuminanceOffset=0,this.motionTimeout=5,this.staticTimeout=30,this.staticTriggerThreshold=3,this.staticRenewThreshold=3,this.staticOnDelay=0,this.entitiesConfig={},this.logLevels={},this.bluetoothEnabled=!1,this.co2Enabled=!1,this.ledMode="Manual Control",this.ledBrightness=1,this.ledPresenceColor="#CC33FF",this.relayTriggerMode="disabled",this.relayContactMode="no",this.targetUpdateRateMs=1e3,this.zoneUpdateRateMs=1e3,this._overrides={},this.localize=t=>t}render(){return G`
    ...
    ><ha-icon icon="mdi:help-circle-outline"></ha-icon><span class="setting-info-tooltip">${t}</span></button>`}renderDetectionRanges(){const t=pe(this.roomWidth,this.roomDepth,this.perspective,this.grid),e=me(this.grid,this.roomWidth,this.perspective),i=t>0?Math.min(t,6):6,o=t>0?Math.min(t,16):16,s=this.targetAutoDistance?i:this.targetMaxDistance,r=this.staticAutoDistance?o:this.staticMaxDistance,n="opacity: 0.5; pointer-events: none;";return G`
    ...
    `}_fireStartCalibration(){this.dispatchEvent(new CustomEvent("start-calibration",{bubbles:!0,composed:!0}))}_fireCancel(){this._setupStep=null,this._wizardCorners=[null,null,null,null],this._wizardCornerIndex=0,this._wizardOffsetSide="",this._wizardOffsetFb="",this.dispatchEvent(new CustomEvent("wizard-cancel",{bubbles:!0,composed:!0}))}}be.styles=[qt,ie,Qt,n`
      :host {
        display: block;
      }
    ...
    `],t([pt({attribute:!1})],be.prototype,"hass",void 0),t([pt({type:String})],be.prototype,"selectedMac",void 0),t([pt({attribute:!1})],be.prototype,"rawTargets",void 0),t([pt({attribute:!1})],be.prototype,"sensorState",void 0),t([pt({attribute:!1})],be.prototype,"devices",void 0),t([pt({attribute:!1})],be.prototype,"localize",void 0),t([pt({type:Number})],be.prototype,"initialRoomWidth",void 0),t([pt({type:Number})],be.prototype,"initialRoomDepth",void 0),t([pt({type:String})],be.prototype,"mode",void 0),t([gt()],be.prototype,"_setupStep",void 0),t([gt()],be.prototype,"_wizardSaving",void 0),t([gt()],be.prototype,"_wizardCornerIndex",void 0),t([gt()],be.prototype,"_wizardCorners",void 0),t([gt()],be.prototype,"_wizardRoomWidth",void 0),t([gt()],be.prototype,"_wizardRoomDepth",void 0),t([gt()],be.prototype,"_wizardCapturing",void 0),t([gt()],be.prototype,"_wizardCaptureProgress",void 0),t([gt()],be.prototype,"_wizardCapturePaused",void 0),t([gt()],be.prototype,"_wizardOffsetSide",void 0),t([gt()],be.prototype,"_wizardOffsetFb",void 0),customElements.get("epp-wizard")||customElements.define("epp-wizard",be);class ye extends ct{constructor(){super(...arguments),this.overlayMode=null,this.localize=t=>t}render(){return G`
	...
	`,t([pt({attribute:!1})],ye.prototype,"overlayMode",void 0),t([pt({attribute:!1})],ye.prototype,"localize",void 0),customElements.get("epp-overlay-sidebar")||customElements.define("epp-overlay-sidebar",ye);const xe={normal:{trigger:5,renew:3,timeout:10,handoff_timeout:3},thoroughfare:{trigger:3,renew:2,timeout:3,handoff_timeout:1},rest:{trigger:7,renew:1,timeout:30,handoff_timeout:10}},we=["#E69F00","#56B4E9","#009E73","#F0E442","#0072B2","#D55E00","#CC79A7"];function $e(t,e,i,o,s,r,n){if(0===t){const t=xe[i]||xe.normal;return"custom"===i?{trigger:o,renew:s,timeout:r,handoffTimeout:n}:{trigger:t.trigger,renew:t.renew,timeout:t.timeout,handoffTimeout:t.handoff_timeout}}if(t>0&&t<=e.length){const i=e[t-1];if(i){const t=xe[i.type]||xe.normal;return"custom"===i.type?{trigger:i.trigger??t.trigger,renew:i.renew??t.renew,timeout:i.timeout??t.timeout,handoffTimeout:i.handoff_timeout??t.handoff_timeout}:{trigger:t.trigger,renew:t.renew,timeout:t.timeout,handoffTimeout:t.handoff_timeout}}}return{trigger:5,renew:3,timeout:10,handoffTimeout:3}}class ze extends ct{constructor(){super(...arguments),this.zoneConfigs=[],this.activeZone=null,this.roomType="normal",this.roomTrigger=xe.normal.trigger,this.roomRenew=xe.normal.renew,this.roomTimeout=xe.normal.timeout,this.roomHandoffTimeout=xe.normal.handoff_timeout,this.localZoneState=new Map,this.localize=t=>t}render(){return this._renderZoneSidebar()}_renderZoneSidebar(){return G`
			...
			>
				...
				>
					...
					<select
						...
						.value=${this.roomType}
						@change=${t=>{const e=t.target.value,i=xe[e]||xe.normal;this.dispatchEvent(new CustomEvent("room-config-change",{detail:{updates:{roomType:e,roomTrigger:i.trigger,roomRenew:i.renew,roomTimeout:i.timeout,roomHandoffTimeout:i.handoff_timeout}},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("dirty",{bubbles:!0,composed:!0}))}}
						@click=${t=>t.stopPropagation()}
					>
						<option value="normal">
		...
		`}_renderZoneTypeControls(t,e){const i="custom"===t.type,o=xe[t.type]||xe.normal,s=t.trigger??o.trigger,r=t.renew??o.renew,n=t.timeout??o.timeout,a=t.handoff_timeout??o.handoff_timeout,l=`width: 100%; display: flex; align-items: center; gap: 4px; font-size: 12px; opacity: ${i?1:.5};`;return G`
			<div
				class="zone-item-row zone-settings-row"
				style="flex-wrap: wrap; gap: 3px; padding: 4px 8px;"
			>
				...
				>
					...
					<select
						...
						style="flex: 1; min-width: 0;"
						.value=${t.type}
						@change=${t=>{const i=t.target.value,o=xe[i]||xe.normal;this.dispatchEvent(new CustomEvent("zone-config-change",{detail:{index:e,updates:{type:i,trigger:o.trigger,renew:o.renew,timeout:o.timeout,handoff_timeout:o.handoff_timeout}},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("dirty",{bubbles:!0,composed:!0}))}}
						@click=${t=>t.stopPropagation()}
					>
						<option value="normal">
							${this.localize("zones.normal")}
    ...
    `}_renderProtocolBanner(){const t=this._devices.find(t=>t.mac===this._selectedMac);if(!t||"compatible"===t.config_protocol_status)return V;const e=t.config_protocol_status,i="firmware_behind"===e,o="unavailable"===e?this._localize("protocol.unavailable"):i?this._localize("protocol.firmware_behind"):this._localize("protocol.firmware_ahead");return G`
		...
		`}_retryConnection(){this._selectedMac&&this._loadDeviceConfig(this._selectedMac)}_renderLiveGrid(){for(let t=0;t<this._targets.length;t++){const e=this._targets[t];null!=e.x&&null!=e.y&&"active"===e.status&&(this._zoneEngineState.targetPrevXY[t]={x:e.x,y:e.y})}const t={};for(const[e,i]of Object.entries(this._zoneState.occupancy))t[Number(e)]=i;return G`
			...
			></epp-grid>
		`}_showTargetMenu(t){this._targetMenu=t}_closeTargetMenu(){this._targetMenu=null}_targetCellIndex(t,e){const i=ae(t,e,this._roomWidth,this._roomDepth);if(!i)return-1;const o=Math.floor(i.col),s=Math.floor(i.row);return o<0||o>=wt||s<0||s>=$t?-1:s*wt+o}_dismissTarget(){if(!this._targetMenu)return;const t=this._targetCellIndex(this._targetMenu.x,this._targetMenu.y);t>=0&&(this._dismissedTargets=new Map(this._dismissedTargets),this._dismissedTargets.set(this._targetMenu.targetIndex,t),this.requestUpdate()),this._closeTargetMenu()}async _setInterference(t){if(!this._targetMenu)return;const e=this._targetCellIndex(this._targetMenu.x,this._targetMenu.y);e<0||!Ct(this._grid[e])?this._closeTargetMenu():(this._grid=new Uint8Array(this._grid),this._grid[e]=At(this._grid[e],t),this._dirty=!0,this._closeTargetMenu(),await this._gridCtrl.applyLayout())}_renderTargetMenu(){if(!this._targetMenu)return V;const{pctX:t,pctY:e}=this._targetMenu;return G`
    ...
    `}_toggleAccordion(t){this._openAccordions=this._openAccordions.has(t)?new Set:new Set([t])}_getSensorRoomPosition(){return ue(this._perspective)}_autoDetectionRange(){return pe(this._roomWidth,this._roomDepth,this._perspective,this._grid)}_renderSettings(){return G`
      <div class="panel">
        ${this._renderHeader()}
        <epp-settings-view
          .sensorState=${this._sensorState}
    ...
    `}_renderFurnitureOverlay(t,e,i,o,s){return this._furniture.length?G`
			<epp-furniture-overlay
				...
				@furniture-delete=${t=>{this._removeFurniture(t.detail)}}
			></epp-furniture-overlay>
		`:V}}Zi.styles=[Xt,Yt,Kt,qt,ie,ee,se,re,n`
    .cell {
      cursor: pointer;
      transition: opacity 0.1s;
    }
  ...
  `],t([pt({attribute:!1})],Zi.prototype,"hass",void 0),t([gt()],Zi.prototype,"_grid",void 0),t([gt()],Zi.prototype,"_zoneConfigs",void 0),t([gt()],Zi.prototype,"_activeZone",void 0),t([gt()],Zi.prototype,"_roomType",void 0),t([gt()],Zi.prototype,"_roomTrigger",void 0),t([gt()],Zi.prototype,"_roomRenew",void 0),t([gt()],Zi.prototype,"_roomTimeout",void 0),t([gt()],Zi.prototype,"_roomHandoffTimeout",void 0),t([gt()],Zi.prototype,"_targetAutoDistance",void 0),t([gt()],Zi.prototype,"_targetMaxDistance",void 0),t([gt()],Zi.prototype,"_staticAutoDistance",void 0),t([gt()],Zi.prototype,"_staticMinDistance",void 0),t([gt()],Zi.prototype,"_staticMaxDistance",void 0),t([gt()],Zi.prototype,"_temperatureOffset",void 0),t([gt()],Zi.prototype,"_humidityOffset",void 0),t([gt()],Zi.prototype,"_illuminanceOffset",void 0),t([gt()],Zi.prototype,"_motionTimeout",void 0),t([gt()],Zi.prototype,"_staticTimeout",void 0),t([gt()],Zi.prototype,"_staticTriggerThreshold",void 0),t([gt()],Zi.prototype,"_staticRenewThreshold",void 0),t([gt()],Zi.prototype,"_staticOnDelay",void 0),t([gt()],Zi.prototype,"_logLevels",void 0),t([gt()],Zi.prototype,"_bluetoothEnabled",void 0),t([gt()],Zi.prototype,"_co2Enabled",void 0),t([gt()],Zi.prototype,"_ledMode",void 0),t([gt()],Zi.prototype,"_ledBrightness",void 0),t([gt()],Zi.prototype,"_ledPresenceColor",void 0),t([gt()],Zi.prototype,"_relayTriggerMode",void 0),t([gt()],Zi.prototype,"_relayContactMode",void 0),t([gt()],Zi.prototype,"_targetUpdateRateMs",void 0),t([gt()],Zi.prototype,"_zoneUpdateRateMs",void 0),t([gt()],Zi.prototype,"_entitiesConfig",void 0),t([gt()],Zi.prototype,"_sidebarTab",void 0),t([gt()],Zi.prototype,"_showDeleteCalibrationDialog",void 0),t([gt()],Zi.prototype,"_showLiveMenu",void 0),t([gt()],Zi.prototype,"_showCustomIconPicker",void 0),t([gt()],Zi.prototype,"_customIconValue",void 0),t([gt()],Zi.prototype,"_furniture",void 0),t([gt()],Zi.prototype,"_selectedFurnitureId",void 0),t([gt()],Zi.prototype,"_targets",void 0),t([gt()],Zi.prototype,"_rawTargets",void 0),t([gt()],Zi.prototype,"_sensorState",void 0),t([gt()],Zi.prototype,"_zoneState",void 0),t([gt()],Zi.prototype,"_showHitCounts",void 0),t([gt()],Zi.prototype,"_showDebugLog",void 0),t([gt()],Zi.prototype,"_showBackendDebugLog",void 0),t([gt()],Zi.prototype,"_overlayMode",void 0),t([gt()],Zi.prototype,"_targetMenu",void 0),t([gt()],Zi.prototype,"_isPainting",void 0),t([gt()],Zi.prototype,"_paintAction",void 0),t([gt()],Zi.prototype,"_saving",void 0),t([gt()],Zi.prototype,"_dirty",void 0),t([gt()],Zi.prototype,"_showUnsavedDialog",void 0),t([gt()],Zi.prototype,"_showTemplateSave",void 0),t([gt()],Zi.prototype,"_showTemplateLoad",void 0),t([gt()],Zi.prototype,"_templateName",void 0),t([gt()],Zi.prototype,"_devices",void 0),t([gt()],Zi.prototype,"_selectedMac",void 0),t([gt()],Zi.prototype,"_loading",void 0),t([gt()],Zi.prototype,"_setupStep",void 0),t([gt()],Zi.prototype,"_view",void 0),t([gt()],Zi.prototype,"_openAccordions",void 0),t([gt()],Zi.prototype,"_perspective",void 0),t([gt()],Zi.prototype,"_roomWidth",void 0),t([gt()],Zi.prototype,"_roomDepth",void 0),customElements.get("eppgrid-panel")||customElements.define("eppgrid-panel",Zi);export{Zi as EPPGridPanel};
